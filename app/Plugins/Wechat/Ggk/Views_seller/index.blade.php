...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="boxcontent boxwhite">
            <div class="box">
                <div class="title-brown">{{ $lang['my_prize_log'] }}</div>
                <div class="Detail">
...
<script type="text/javascript">
    ...
    function act_draw(obj) {
        ...
        if (!disbled) {
            ...
            $.post("{{ route('wechat/plugin_action', ['name'=>'ggk', 'wechat_ru_id' => $wechat_ru_id]) }}", {act: 'draw'}, function (result) {
                if (result.status == 2) {
    ...
    function act_do(result) {
        ...
        $.post("{{ route('wechat/plugin_action', ['name' => 'ggk', 'wechat_ru_id' => $wechat_ru_id]) }}", {
            act: 'do',
