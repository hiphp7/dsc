...
<div class="wrapper">
	...
	<div class="content_tips">
		<div class="flexilist">
			<div class="main-info">
				<form action="{{ route('admin/wechat/extend_edit', array('ks'=>'zjd')) }}" method="post" class="form-horizontal" role="form" >
				<div class="switch_info">
				    ...
				    <div class="item">
				        <div class="label-t">{{ $lang['point_status_zjd'] }}：</div>
			            <div class="label_value">
			                <div class="checkbox_items">
	                            <div class="checkbox_item">
				                    <input type="radio" name="cfg_value[point_status]" class="ui-radio event_zhuangtai clicktype" id="value_121_0" value="1" checked="true"
...
">{{ $lang['wechat_open'] }}</label>
				                ...
				                <div class="checkbox_item">
				                    <input type="radio" name="cfg_value[point_status]" class="ui-radio event_zhuangtai clicktype" id="value_121_1" value="0"
...
">{{ $lang['wechat_close'] }}</label>
				    ...
				    <div class="item
@if(isset($config['config']['point_status']) && $config['config']['point_status'] == 0)
hidden
@endif
" id="open_point">
				        <div class="label-t">{{ $lang['point_value_zjd'] }}：</div>
			            <div class="label_value">
			                <input type="text" name="cfg_value[point_value]" class="text" value="{{ $config['config']['point_value'] ?? '' }}" />
			            </div>
				    </div>
				    <div class="item
@if(isset($config['config']['point_status']) && $config['config']['point_status'] == 1)
hidden
@endif
" id="close_point">
				        <div class="label-t">{{ $lang['prize_num_zjd'] }}：</div>
				        <div class="label_value">
...
>1 {{ $lang['minute'] }}</option>
				    ...
				    <div class="item">
				        <div class="label-t">{{ $lang['people_num_zjd'] }}：</div>
				            <div class="label_value">
...
@endif
			                ...
			                <div class="notic">{{ $lang['prize_list_notice_zjd'] }}</div>
			            </div>
				    </div>
				    <div class="item">
...
<script type="text/javascript">
	...
	$(".clicktype").click(function(){
		...
		if(1 == val && $("#open_point").hasClass("hidden")){
            ...
            $("#point_interval").hide().addClass("hidden");
		...
		if(0 == val && !$("#open_point").hasClass("hidden")){
            ...
            $("#point_interval").show().removeClass("hidden");
		}
	});
    ...
    function addprize(obj){
    	switch(num)
        {
            ...
            case 5:
              ...
              break;
            case 6:
              prize_level = "{{ $lang['prize_level_0'] }}";
              break;
            default:
              prize_level = "";
        }
