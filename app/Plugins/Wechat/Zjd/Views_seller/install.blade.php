...
@endif
                    ...
                    <div class="form_prompt"></div>
                    <div class="notic">注意：建议最多添加6项，最后一项必须设为未中奖项，内容可随意填写（{{ $lang['for_example'] }}：差一点就中奖了）。概率总和小于100%，不能为0</div>
                </dd>
            </dl>
            <dl>
