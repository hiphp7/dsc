...
@else
                ...
                <a href="{{ route('seller/wechat/data_list', array('type' => $config['keywords'], 'function' => 'qrpay_discounts', 'handler' => 'edit', 'id' => $config['market_id'])) }}" class="sc-btn sc-blue-btn"  ><div class="fbutton"><div class="add " title="添加优惠"><span><i class="fa fa-plus"></i>添加优惠</span></div></div></a>
...
@if($val['status'] == '1')
                    ...
                    <a class="btn_edit" href="{{ route('seller/wechat/data_list', array('type' => $config['keywords'], 'function' => 'qrpay_discounts', 'handler' => 'edit', 'id' => $val['id'])) }}"><i class="fa fa-edit"></i>编辑</a>
                    <a class="btn_trash disabled_dis" href="javascript:;" data-href="{!!  route('seller/wechat/market_action', array('type' => $config['keywords'], 'handler' => 'disabled', 'id' => $val['id'])) !!}"  title="使失效" ><i class="fa fa-ban"></i>使失效</a>
