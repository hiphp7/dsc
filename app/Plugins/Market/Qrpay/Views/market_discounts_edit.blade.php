...
<div class="wrapper">
	...
	<div class="content_tips">
		...
		<div class="flexilist of">
            <div class="main-info">
                <form action="{{ route('admin/wechat/data_list', array('type' => $config['keywords'], 'function' => 'qrpay_discounts', 'handler' => 'edit', 'id' => $config['market_id'])) }}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data" onsubmit="return false;">
...
$(function(){
    ...
    $(".form-horizontal").submit(function(){
        ...
        $.post("{!!  route('admin/wechat/data_list', array('type' => $config['keywords'], 'function' => 'qrpay_discounts', 'handler' => 'edit', 'id' => $config['market_id']))  !!}", ajax_data, function(data){
            layer.msg(data.msg);
            if (data.error == 0) {
                if (data.url) {
