...
<div class="wrapper">
	<div class="title"><a href="{{ route('admin/wechat/market_index') }}" class="s-back">返回</a>{{ $config['name'] }} - 收款码</div>
	<div class="content_tips">
        <div class="tabs_info">
            <ul>
                <li class="curr"><a href="{{ route('admin/wechat/market_list', array('type' => $config['keywords'])) }}">收款码</a></li>
		...
		<div class="flexilist of">
			<div class="common-head">
                <div class="fl">
                	<a href="{{ route('admin/wechat/market_edit', array('type' => $config['keywords'])) }}" ><div class="fbutton"><div class="add " title="添加收款码"><span><i class="fa fa-plus"></i>添加收款码</span></div></div></a>
                </div>
            </div>
...
@foreach($list as $val)
                    ...
                    <tr class="text-center wall-list">
                        ...
                        <td>
                        <div class="info_btn">
                            <a class="button btn-info" href="{{ route('admin/wechat/market_edit', array('type' => $config['keywords'], 'id' => $val['id'])) }}">编辑</a>
                            <a class="button btn-info" href="{{ route('admin/wechat/data_list', array('type' => $config['keywords'], 'function' => 'qrpay_log_list', 'id' => $val['id'])) }}">记录</a>

                            <a class="button btn-primary " href="{{ route('admin/wechat/data_list', array('type' => $config['keywords'], 'function' => 'download_qrpay', 'id' => $val['id'])) }}">下载</a>
                            <a class="button btn-danger bg-red reset-qrpay" data-href="{!!  route('admin/wechat/data_list', array('type' => $config['keywords'], 'function' => 'reset_qrpay', 'id' => $val['id']))  !!}" href="javascript:;">重置</a>
                            <!-- <a class="button btn-danger bg-red qr-delete" data-href="{!!  route('admin/wechat/market_action', array('type' => $config['keywords'], 'handler' => 'qr_delete', 'id' => $val['id']))  !!}" href="javascript:;">删除</a> -->
                        </div>
                        </td>
                    </tr>
