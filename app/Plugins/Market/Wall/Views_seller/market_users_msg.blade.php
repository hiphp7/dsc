...
@endif
                    ...
                    <td>{{ $val['status'] }}</td>
                    <td class="info_btn">
                        <a class="button btn-danger bg-red data_delete" data-href="{!!  route('seller/wechat/market_action', array('type' => $config['keywords'], 'handler' => 'data_delete', 'market_id' => $config['market_id'], 'msg_id' => $val['id']))  !!}" href="javascript:;">删除</a>
                    </td>
                </tr>
