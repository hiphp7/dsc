...
class Captcha
{
    ...
    public function entry($id = '')
    {
        ...
        // 验证码使用随机字体
        $ttfPath = storage_public('/data/verify/' . ($this->useZh ? 'zhttfs' : 'ttfs') . '/');
    ...
    {
        $path = storage_public('/data/verify/bgs/');
        $dir = dir($path);
