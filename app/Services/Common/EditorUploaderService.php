...
//        "POST" => "文件大小超出 post_max_size 限制" ,
    ...
    {
        $params['fileField'] = isset($params['fileField']) ? $params['fileField'] : '';
        $params['config'] = isset($params['config']) ? $params['config'] : '';
        $params['base64'] = isset($params['base64']) ? $params['base64'] : false;

        $this->fileField = $params['fileField'];
        $this->config = $params['config'];
        $this->stateInfo = $this->stateMap[0];
        $this->upFile($params['base64']);
    }
