...
define('VERSION', 'v8.8.8');
define('RELEASE', '20200212');
...
define('MOBILE_WXAPP', dirname(__DIR__) . '/Modules/Admin/Controllers/WxappController.php'); // 小程序
define('MOBILE_TEAM', dirname(__DIR__) . '/Modules/Admin/Controllers/TeamController.php'); //拼团目录
define('MOBILE_BARGAIN', dirname(__DIR__) . '/Modules/Admin/Controllers/BargainController.php'); //砍价目录
define('MOBILE_KEFU', dirname(__DIR__) . '/Http/Controllers/Chat/IndexController.php'); //客服目录
define('MOBILE_APP', dirname(__DIR__) . '/Modules/Admin/Controllers/AppController.php'); //APP目录

define('SUPPLIERS', dirname(__DIR__) . '/Modules/Suppliers/'); //供应链后台目录
...
if (!defined('GROUPBUY_LEADER')) {
    define('GROUPBUY_LEADER', file_exists(dirname(__DIR__) . '/Custom/Cgroup'));
}
