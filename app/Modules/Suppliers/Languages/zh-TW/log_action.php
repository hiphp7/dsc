...
$_LANG['log_action']['privilege'] = '許可權管理';
...
$_LANG['log_action']['apply_sn'] = '商家等級申請';//by kong
...
$_LANG['log_action']['db_backup'] = '資料庫備份';
...
$_LANG['log_action']['suppliers_goods'] = '供貨商商品管理';

$_LANG['log_action']['reg_fields'] = '會員注冊項';
$_LANG['log_action']['users_real'] = '實名認證用戶'; // 實名認證 qin

$_LANG['log_action']['admin_login'] = '管理員登陸'; //管理員登陸

$_LANG['log_action']['goods_transport'] = '商品運費模板'; //運費模板

$_LANG['log_action']['supply_login'] = '供應商登陸';

$_LANG['log_action']['goods_type_cat'] = '屬性分類';

$_LANG['log_action']['gallery_album'] = '圖片相冊';
