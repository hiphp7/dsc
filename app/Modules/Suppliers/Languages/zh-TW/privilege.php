<?php
/* 欄位信息 */
$_LANG['suppliers_backstage'] = '供貨商後台';
$_LANG['please_input_code'] = '請輸入驗證碼';
$_LANG['lable_login'] = '登 錄';
$_LANG['lable_forget_password'] = '忘記密碼';
$_LANG['send'] = '發 送';
$_LANG['reset_password'] = '重置密碼';
$_LANG['no_empty_name'] = '用戶名不能為空';
$_LANG['no_empty_verification'] = '驗證碼不能為空';
$_LANG['verification_error'] = '驗證碼錯誤';
$_LANG['no_empty_admin_name'] = '管理員名稱不能為空';
$_LANG['no_empty_emile'] = '郵箱不能為空';
$_LANG['mailbox_format_incorrect'] = '郵箱格式不正確';
$_LANG['no_empty_repeat'] = '重復密碼不能為空';

$_LANG['user_id'] = '編號';
$_LANG['user_name'] = '用戶名';
$_LANG['parent_name'] = '父管理員';
$_LANG['email'] = 'Email地址';
$_LANG['password'] = '密  碼';
...
$_LANG['invalid_name_notic'] = '無效名稱，不可使用';

$_LANG['back_admin_list'] = '返回管理員列表';

$_LANG['add_faile'] = '添加失敗';

/* 提示信息 */
$_LANG['js_languages']['user_name_empty'] = '管理員用戶名不能為空!';
$_LANG['js_languages']['password_empty'] = '密碼不能為空!';
...
$_LANG['js_languages']['pwd_confirm_empty'] = '確認密碼不能為空';
$_LANG['js_languages']['old_password_empty'] = '舊密碼不能為空';
$_LANG['js_languages']['old_password_error'] = '舊密碼不正確';
$_LANG['js_languages']['new_password_empty'] = '新密碼不能為空';
$_LANG['js_languages']['new_password_error'] = '密碼長度不能小於六位';
$_LANG['js_languages']['password_error'] = '兩次輸入的密碼不一致!';
$_LANG['js_languages']['captcha_empty'] = '您沒有輸入驗證碼!';
$_LANG['js_languages']['username_password_error'] = '用戶名或密碼錯誤!';
$_LANG['js_languages']['pwd_bit_format'] = '只能包括中文字、英文字母、數字和下劃線';
...
$_LANG['login_error'] = '您的IP暫時限制登錄請稍後再試（30分鍾內）';
...
$_LANG['click_for_another'] = '換一張';
$_LANG['signin_now'] = '登&nbsp;&nbsp;錄';
$_LANG['remember'] = '保存登錄信息';
...
$_LANG['click_button2'] = '確 定';

$_LANG['admin_title'] = '登錄頁';
$_LANG['management_center'] = '管理中心';
$_LANG['administrator'] = '管理員';
$_LANG['jurisdiction'] = '許可權';
$_LANG['business_admin'] = '商城管理員';

/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['allot'][0] = '該頁面展示商城所有功能許可權。';
$_LANG['operation_prompt_content']['allot'][1] = '打鉤即是分配許可權，請謹慎操作。';
$_LANG['operation_prompt_content']['allot'][2] = '初始化是基本功能許可權。';

$_LANG['operation_prompt_content']['info'][0] = '可從管理平台手動添加一名新管理員，並填寫相關信息。';
$_LANG['operation_prompt_content']['info'][1] = '新增管理員後可從管理員列表中找到該條數據，並再次進行編輯操作。';

$_LANG['operation_prompt_content']['list'][0] = '該頁面展示了所有入駐平台的管理員列表。';
$_LANG['operation_prompt_content']['list'][1] = '可手動添加管理員並分配許可權、查看日誌等操作。';
$_LANG['operation_prompt_content']['list'][2] = '注意：商家許可權，已移至商城->商家列表。';
