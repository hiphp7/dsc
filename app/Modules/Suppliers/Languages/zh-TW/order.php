...
$_LANG['confirm_pay'] = '確定支付嗎？';
$_LANG['express_mode'] = '快遞方式：';
$_LANG['cash_delivery'] = '貨到付款';
$_LANG['transfer'] = '銀行匯款/轉帳';
$_LANG['adjust_price'] = '調節訂單金額';
$_LANG['adjustment_amount'] = '調節金額：';
$_LANG['order_remarks'] = '訂單備註：';
$_LANG['audit_status'] = '審核狀態：';
$_LANG['please_select_goods'] = '請勾選商品';
$_LANG['confirm_del'] = '您確定要刪除嗎？';
...
/* 訂單列表 */
$_LANG['including_freight'] = '含運費：';
$_LANG['page_count'] = '共';
$_LANG['count_table'] = '條記錄';
$_LANG['order_details'] = '訂單詳情';
$_LANG['user_name'] = '姓名：';
...
$_LANG['js_languages']['jl_order_invoice'] ='配送方式和發貨單號不可為空';
