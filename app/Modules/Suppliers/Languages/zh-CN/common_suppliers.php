...
$_LANG['03_goods_transport'] = "运费模板";
$_LANG['04_gallery_album'] = "图片库管理";

//订单
$_LANG['02_suppliers_order'] = "订单";
$_LANG['01_order_list'] = "订单列表";
$_LANG['12_back_apply'] = '退货单列表';

//商家
$_LANG['03_suppliers'] = "账户";
$_LANG['10_account_manage'] = "供应商账户";

//供应商
$_LANG['01_suppliers_goods'] = "商品";
$_LANG['suppliers_promotion'] = "促销";
$_LANG['suppliers_order'] = "订单";
$_LANG['suppliers_stats'] = "统计";
$_LANG['02_goods_type'] = "商品类型";
...
$_LANG['04_suppliers_sale_order_stats'] = '报表';
...
$_LANG['standard_goods_lib_confirm'] = '确定分享此商品加入供应商商品库吗？';
$_LANG['no_standard_goods_lib_confirm'] = '确定取消分享此商品加入供应商商品库吗？';
$_LANG['share'] = "分享";
$_LANG['no_share'] = "取消分享";
...
//网页底部
$_LANG['seller_footer'] = '©&nbsp;2005-2017 上海商创网络科技有限公司，并保留所有权利。Powered by';
//网页首部
$_LANG['header_suppliers'] = '供应商';
$_LANG['header_home'] = '首页';
$_LANG['header_clearing_cache'] = '清缓存';
$_LANG['header_logout'] = '退出';
$_LANG['title_supplier_center'] = '供应商中心';
...
$_LANG['lable_forget_password'] = '忘记密码';

$_LANG['user_not_isset'] = '用户不存在';
$_LANG['send_mail_error'] = '发送邮箱失败';
$_LANG['email_username_error'] = '邮箱用户名错误';
$_LANG['update_pwd_success'] = '更新密码成功';
