...
$_LANG['express_mode'] = '快递方式：';
$_LANG['cash_delivery'] = '货到付款';
$_LANG['transfer'] = '银行汇款/转帐';
$_LANG['adjust_price'] = '调节订单金额';
$_LANG['adjustment_amount'] = '调节金额：';
$_LANG['order_remarks'] = '订单备注：';
$_LANG['audit_status'] = '审核状态：';
$_LANG['please_select_goods'] = '请勾选商品';
$_LANG['confirm_del'] = '您确定要删除吗？';
...
/* 订单列表 */
$_LANG['including_freight'] = '含运费：';
$_LANG['page_count'] = '共';
$_LANG['count_table'] = '条记录';
$_LANG['order_details'] = '订单详情';
$_LANG['user_name'] = '姓名：';
...
$_LANG['js_languages']['jl_order_invoice'] ='配送方式和发货单号不可为空';
