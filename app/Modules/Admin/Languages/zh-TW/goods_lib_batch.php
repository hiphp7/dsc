...
$_LANG['goods_lib_batch_add'] = '本地商品庫商品批量上傳';
...
$_LANG['upload_goods_lib']['integral'] = '積分購買額度';
...
$_LANG['upload_goods_lib']['goods_number'] = '庫存數量';
$_LANG['upload_goods_lib']['warn_number'] = '庫存警告數量';
$_LANG['upload_goods_lib']['is_best'] = '是否精品';
$_LANG['upload_goods_lib']['is_new'] = '是否新品';
$_LANG['upload_goods_lib']['is_hot'] = '是否熱銷';
$_LANG['upload_goods_lib']['is_on_sale'] = '是否上架';
$_LANG['upload_goods_lib']['is_alone_sale'] = '能否作為普通商品銷售';
...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['batch'][0] = '首先下載csv文件，打開excel表格添加多個商品信息欄位。';
$_LANG['operation_prompt_content']['batch'][1] = '上傳編輯好的csv文件，選擇數據格式、分類、編碼進行上傳文件。';
