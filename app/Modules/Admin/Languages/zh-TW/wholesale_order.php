...
/* 單品退貨單列表 */
$_LANG['return_exchange_info'] = '買家提交的退換貨申請信息管理。';
$_LANG['where_search'] = '可通過訂單號進行查詢，側邊欄進行高級搜索。';
$_LANG['refund_method'] = '退款方式';
$_LANG['goods_table'] = '【商品】';
$_LANG['discount_price'] = '【折扣】';
$_LANG['freight_included'] = '(含運費)';
$_LANG['back_balance'] = '退回到余額';
$_LANG['offline_refund'] = '線下退款';

/* 單品退貨單信息 */
$_LANG['select_company'] = '請選擇快遞公司';
$_LANG['input_courier_number'] = '請填寫快遞單號';
...
$_LANG['purchase_order_list'] = '采購訂單列表';
$_LANG['show_purchase_order_list'] = '顯示采購訂單列表信息';
$_LANG['all_order'] = '全部訂單';
$_LANG['substitute_payment'] = '待付款';
$_LANG['shipped'] = '待發貨';
$_LANG['completed'] = '已完成';
$_LANG['return_order'] = '退貨訂單';
$_LANG['order_sn'] = '訂單編號/商品編號/商品關鍵字';
$_LANG['wholesale'] = '批發';
$_LANG['merge'] = '合並';
...
$_LANG['wholesale_order_info'] = '采購訂單詳情';
...
$_LANG['pay_time'] = '支付時間';
$_LANG['personal_invoice'] = '個人普通發票';
$_LANG['enterprise_invoice'] = '企業普通發票';
$_LANG['code_s'] = '識別碼：';
$_LANG['vat_invoice'] = '(增值稅發票)';
$_LANG['code'] = '識別碼';
$_LANG['order_remark'] = '訂單備註：';
$_LANG['adjustment_amount'] = '調節金額：';
$_LANG['confirm'] = '確認';
$_LANG['wait_moment'] = '正在查詢物流信息，請稍後...';
$_LANG['sure_pay'] = '確定支付嗎？';
$_LANG['set_grab_sheet'] = '設置搶單';
$_LANG['consignee'] = '收貨人信息';
...
$_LANG['ps'][PS_REFOUND_PART] = '<font color="red">部分退款</font>';
$_LANG['ps'][PS_REFOUND] = '<font color="red">已退款</font>';
