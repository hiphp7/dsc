...
$_LANG['attention_list'] = '關注管理模板';
$_LANG['remind_of_new_order'] = '新訂單提醒模板';
$_LANG['goods_booking'] = '缺貨回復模板';
$_LANG['user_message'] = '留言回復模板';
$_LANG['recomment'] = '用戶評論回復模板';
$_LANG['seller_signin'] = '商家登錄信息模板';
$_LANG['sale_notice'] = '商品降價通知模板';
$_LANG['merchants_allpy_grade'] = '商家店鋪升級模板';
$_LANG['user_register'] = '會員注冊模板';
$_LANG['user_account_code'] = "會員提現充值模板";
...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '請先選擇郵件模板分類。';
$_LANG['operation_prompt_content']['list'][1] = '請按照模板內提供的變數進行修改，以免出錯。';
