...
$_LANG['log_account_change_no'] = '記錄帳戶變動失敗';
...
/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['info'][0] = '管理員對會員賬戶進行資金、成長值、消費積分進行調整。';
$_LANG['operation_prompt_content']['info'][1] = '涉及資金方面管理員要謹慎操作。';
