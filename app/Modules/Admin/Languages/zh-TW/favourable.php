...
$_LANG['lab_act_range_desc'][0] = '商品已經參與其他優惠活動';
$_LANG['lab_act_range_desc'][1] = '分類商品已經參與其他優惠活動';
$_LANG['lab_act_range_desc'][2] = '品牌商品已經參與其他優惠活動';
$_LANG['rs_no_merchants_notice'] = '該賣場下沒有商家，暫時無法參加優惠活動';

$_LANG['drop_activity_thumb'] = '刪除圖標';
$_LANG['confirm_drop_thumb'] = '你確認要刪除該圖標嗎？';
$_LANG['drop_activity_thumb_success'] = '刪除活動圖片成功';
...
$_LANG['notice_act_type'] = '當優惠方式為「享受贈品（特惠品）」時，請輸入允許買家選擇贈品（特惠品）的最大數量，數量為0表示不可選擇贈品；' .
...
$_LANG['js_languages']['select_user_dengji'] = '請選擇享受優惠的會員等級';
$_LANG['js_languages']['min_amount_null'] = '金額下限不能為空';
$_LANG['js_languages']['max_amount_null'] = '金額上限不能為空';
$_LANG['js_languages']['batch_drop_confirm'] = '您確實要刪除選中的優惠活動嗎？';

/* post */
$_LANG['pls_set_user_rank'] = '請設置享受優惠的會員等級';
$_LANG['pls_set_act_range'] = '請設置優惠范圍';
$_LANG['amount_error'] = '金額下限不能大於金額上限';
$_LANG['act_name_exists'] = '該優惠活動名稱已存在，請您換一個';
$_LANG['favourable_fw'] = '';

$_LANG['nolimit'] = '沒有限制';
$_LANG['set_use_range'] = '設置使用范圍';

/* 教程名稱 */
$_LANG['tutorials_bonus_list_one'] = '商城優惠活動說明';

/* 頁面頂部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '展示了所有優惠活動相關信息列表。';
$_LANG['operation_prompt_content']['list'][1] = '可根據商品名稱關鍵字進行搜索，側邊欄高級搜索使用類型、店鋪名稱搜索具體活動信息。';
$_LANG['operation_prompt_content']['list'][2] = '展示信息有：商家名稱、優惠活動名稱、起始時間等，可進行添加、編輯、刪除或批量刪除等操作。';

$_LANG['operation_prompt_content']['info'][0] = '請正確填寫活動信息：優惠活動名稱、活動起始時間、優惠方式（享受贈品、享受滿減、享受折扣）。';
$_LANG['operation_prompt_content']['info'][1] = '前台可在優惠活動頻道頁查看優惠活動詳情。';
