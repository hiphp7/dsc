...
$_LANG['user_guide'] = '<ul>' .
    '<li>根據商品分類、品牌或關鍵字搜索出需要導出的商品。</li>' .
    '<li>選擇數據格式和編碼，進行商品導出。</li>' .
    '</ul>';
...
$_LANG['paipai4']['id'] = 'id';
$_LANG['paipai4']['goods_name'] = '商品名稱';
$_LANG['paipai4']['auctionType'] = '出售方式';
$_LANG['paipai4']['category'] = '商品類目';
$_LANG['paipai4']['shopCategoryId'] = '店鋪類目';
$_LANG['paipai4']['quantity'] = '商品數量';
$_LANG['paipai4']['duration'] = '有效期';
$_LANG['paipai4']['startDate'] = '定時上架';
$_LANG['paipai4']['stuffStatus'] = '新舊程度';
$_LANG['paipai4']['price'] = '價格';
$_LANG['paipai4']['increment'] = '加價幅度';
$_LANG['paipai4']['prov'] = '省';
$_LANG['paipai4']['city'] = '市';
$_LANG['paipai4']['shippingOption'] = '運費承擔';
$_LANG['paipai4']['ordinaryPostFee'] = '平郵';
$_LANG['paipai4']['fastPostFee'] = '快遞';
$_LANG['paipai4']['buyLimit'] = '購買限制';
$_LANG['paipai4']['paymentOption'] = '付款方式';
$_LANG['paipai4']['haveInvoice'] = '有發票';
$_LANG['paipai4']['haveGuarantee'] = '有保修';
$_LANG['paipai4']['secureTradeAgree'] = '支持財付通';
$_LANG['paipai4']['autoRepost'] = '自動重發';
$_LANG['paipai4']['failed_reason'] = '錯誤原因';
$_LANG['paipai4']['pic_filename'] = '圖片';
$_LANG['paipai4']['description'] = '商品詳情';
$_LANG['paipai4']['shelfOption'] = '上架選項';
$_LANG['paipai4']['skin'] = '皮膚風格';
$_LANG['paipai4']['attr'] = '屬性';
$_LANG['paipai4']['chengBao'] = '誠保';
$_LANG['paipai4']['shopWindow'] = '櫥窗';

// 批量上傳商品的欄位
$_LANG['export_dscmall'] = '導出到dscmall數據格式';

$_LANG['dscmall'] = [];
$_LANG['dscmall']['goods_name'] = '商品名稱';
$_LANG['dscmall']['goods_sn'] = '商品貨號';
$_LANG['dscmall']['brand_name'] = '商品品牌';   // 需要轉換成brand_id
$_LANG['dscmall']['market_price'] = '市場售價';
$_LANG['dscmall']['shop_price'] = '本店售價';
$_LANG['dscmall']['integral'] = '積分購買額度';
$_LANG['dscmall']['original_img'] = '商品原始圖';
$_LANG['dscmall']['goods_img'] = '商品圖片';
$_LANG['dscmall']['goods_thumb'] = '商品縮略圖';
$_LANG['dscmall']['keywords'] = '商品關鍵詞';
$_LANG['dscmall']['goods_brief'] = '簡單描述';
$_LANG['dscmall']['goods_desc'] = '詳細描述';
$_LANG['dscmall']['goods_weight'] = '商品重量（kg）';
$_LANG['dscmall']['goods_number'] = '庫存數量';
$_LANG['dscmall']['warn_number'] = '庫存警告數量';
$_LANG['dscmall']['is_best'] = '是否精品';
$_LANG['dscmall']['is_new'] = '是否新品';
$_LANG['dscmall']['is_hot'] = '是否熱銷';
$_LANG['dscmall']['is_on_sale'] = '是否上架';
$_LANG['dscmall']['is_alone_sale'] = '能否作為普通商品銷售';
$_LANG['dscmall']['is_real'] = '是否實體商品';
...
$_LANG['export_data_goods'] = '數據批量導出的商品';
$_LANG['select_type'] = '選擇類型';
$_LANG['all_type'] = '所有類型';
$_LANG['select_data'] = '可選數據列';
$_LANG['output_data'] = '輸出數據列';

$_LANG['page_number'] = '頁數';
$_LANG['total_number'] = '總數';
$_LANG['time'] = '時間';
$_LANG['range'] = '范圍';

$_LANG['js_languages']['downloaded_completed'] = '已下載完成！';
