...
/* 单品退货单列表 */
$_LANG['return_exchange_info'] = '买家提交的退换货申请信息管理。';
$_LANG['where_search'] = '可通过订单号进行查询，侧边栏进行高级搜索。';
$_LANG['refund_method'] = '退款方式';
$_LANG['goods_table'] = '【商品】';
$_LANG['discount_price'] = '【折扣】';
$_LANG['freight_included'] = '(含运费)';
$_LANG['back_balance'] = '退回到余额';
$_LANG['offline_refund'] = '线下退款';

/* 单品退货单信息 */
$_LANG['select_company'] = '请选择快递公司';
$_LANG['input_courier_number'] = '请填写快递单号';
...
$_LANG['purchase_order_list'] = '采购订单列表';
$_LANG['show_purchase_order_list'] = '显示采购订单列表信息';
$_LANG['all_order'] = '全部订单';
$_LANG['substitute_payment'] = '待付款';
$_LANG['shipped'] = '待发货';
$_LANG['completed'] = '已完成';
$_LANG['return_order'] = '退货订单';
$_LANG['order_sn'] = '订单编号/商品编号/商品关键字';
$_LANG['wholesale'] = '批发';
$_LANG['merge'] = '合并';
...
$_LANG['pay_time'] = '支付时间';
$_LANG['personal_invoice'] = '个人普通发票';
$_LANG['enterprise_invoice'] = '企业普通发票';
$_LANG['code_s'] = '识别码：';
$_LANG['vat_invoice'] = '(增值税发票)';
$_LANG['code'] = '识别码';
$_LANG['order_remark'] = '订单备注：';
$_LANG['adjustment_amount'] = '调节金额：';
$_LANG['confirm'] = '确认';
$_LANG['wait_moment'] = '正在查询物流信息，请稍后...';
$_LANG['sure_pay'] = '确定支付吗？';
$_LANG['set_grab_sheet'] = '设置抢单';
$_LANG['consignee'] = '收货人信息';
