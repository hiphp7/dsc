...
$_LANG['upload_goods_lib']['integral'] = '积分购买额度';
...
$_LANG['upload_goods_lib']['goods_number'] = '库存数量';
$_LANG['upload_goods_lib']['warn_number'] = '库存警告数量';
$_LANG['upload_goods_lib']['is_best'] = '是否精品';
$_LANG['upload_goods_lib']['is_new'] = '是否新品';
$_LANG['upload_goods_lib']['is_hot'] = '是否热销';
$_LANG['upload_goods_lib']['is_on_sale'] = '是否上架';
$_LANG['upload_goods_lib']['is_alone_sale'] = '能否作为普通商品销售';
