...
$_LANG['label_user_info'] = '会员信息';
$_LANG['label_user_account'] = '账户';
...
$_LANG['label_user_search'] = '会员名称/昵称/手机号';
...
$_LANG['goto_assets_list'] = '前往虚拟资产列表';
...
$_LANG['notice_rank_points'] = '成长值是一种累计的积分，系统根据该积分来判定用户的会员等级。';
...
$_LANG['user_have_account'] = '会员账号 %s 有虚拟资产。';
...
$_LANG['js_languages']['invalid_rank_points'] = '成长值不是一个整数。';
...
/* 虚拟资产 */
$_LANG['virtual_assets'][0] = '会员余额';
$_LANG['virtual_assets'][1] = '冻结金额';
$_LANG['virtual_assets'][2] = '消费积分';
$_LANG['virtual_assets'][3] = '有效优惠券数量';
$_LANG['virtual_assets'][4] = '有效红包数量';
$_LANG['virtual_assets'][5] = '储值卡金额';
$_LANG['remove_assets_confirm'] = '您确定要删除该会员账号及其虚拟资产信息吗？';
$_LANG['virtual_assets_list'] = '虚拟资产列表';
$_LANG['operation_prompt_content_assets']['list'][0] = '虚拟资产列表展示会员所有的虚拟资产统计。';
$_LANG['operation_prompt_content_assets']['list'][1] = '点击删除按钮确认后可删除会员及其虚拟资产信息。';
