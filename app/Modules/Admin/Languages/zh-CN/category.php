...
$_LANG['phone_catads'] = '手机分类列表广告图';
$_LANG['phone_catads_url'] = '手机分类列表广告链接';
...
$_LANG['phone_catads_notic'] = '（注：手机端专用,建议上传长方形图片（530*250））';
...
$_LANG['catads_url_notic'] = '(请填写手机访问地址，例如：#/goods/913)';
