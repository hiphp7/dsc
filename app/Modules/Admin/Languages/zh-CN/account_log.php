...
$_LANG['js_languages']['rank_points_not_int'] = '成长值不是整数';
...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['info'][0] = '管理员对会员账户进行资金、成长值、消费积分进行调整。';
