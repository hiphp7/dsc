...
$_LANG['cause_repeat'] = "添加退换货原因分类名称重复";
...
$_LANG['application_information'] = '申请信息';
$_LANG['other_express'] = '其他快递';

$_LANG['order_id'] = '订单ID';
$_LANG['business_id'] = '商家ID';
$_LANG['suborder_quantity'] = '子订单数量';
...
$_LANG['action_child_order'] = '操作子订单';
...
$_LANG['ps_not_same'] = '要合并的两个付款状态不能相同';
...
$_LANG['js_languages']['pls_input_should_return'] = '已超出退款实际金额，退款金额最大为：';
$_LANG['js_languages']['pls_input_shipping_fee'] = '已超出退运费实际金额，退款金额最大为：';
...
$_LANG['order_status_08'] = '无效';
$_LANG['order_status_09'] = '退货';
...
$_LANG['refund_type_notic_six'] = "在线退款申请失败，请检查支付方式是否配置，或在线账户资金充足或者联系客服";

$_LANG['batch_delivery_success'] = "批量发货成功";
$_LANG['batch_delivery_failed'] = "批量发货失败，发货单号不能为空";
...
$_LANG['op_agree_apply'] = '同意申请';
$_LANG['op_refound'] = '去退款';

$_LANG['average_coupons'] = "均摊优惠券金额：%s";
$_LANG['average_bonus'] = "均摊红包金额：%s";
