...
class ShopinfoController extends InitController
{
    ...
    {
        $exc = new Exchange($this->dsc->table("article"), $this->db, 'article_id', 'title');
        ...
        if ($_REQUEST['act'] == 'insert') {
            ...
            /* 插入数据 */
            $add_time = gmtime();
            $sql = "INSERT INTO " . $this->dsc->table('article') . "(title, cat_id, content, add_time) VALUES('$title', '0', '$editor','$add_time' )";
            $this->db->query($sql);
        ...
        if ($_REQUEST['act'] == 'edit') {
            ...
            /* 取得文章数据 */
            $sql = "SELECT article_id, title, content FROM " . $this->dsc->table('article') . "WHERE article_id = '$article_id'";
