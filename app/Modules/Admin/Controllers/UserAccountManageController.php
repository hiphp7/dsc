...
class UserAccountManageController extends InitController
{
    ...
    public function index()
    {
        ...
        if (isset($_POST) && isset($_POST['start_date'])) {
            ...
            $today = local_strtotime(local_date('Y-m-d H:i:s'));
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->smarty->assign('action_link', ['text' => $GLOBALS['_LANG']['user_account_manage'], 'href' => 'user_account_manage.php?act=list&start_date=' . local_date('Y-m-d', $start_date) . '&end_date=' . local_date('Y-m-d', $end_date)]);
