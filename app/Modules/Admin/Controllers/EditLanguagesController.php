...
class EditLanguagesController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $lang_arr = [];
            $lang_path = resource_path('lang/' . $GLOBALS['_CFG']['lang']);
            ...
            if ($lang_file == 'common') {
                $file_path = resource_path('lang/' . $GLOBALS['_CFG']['lang'] . '/common.php');
            } elseif ($lang_file == 'shopping_flow') {
                $file_path = resource_path('lang/' . $GLOBALS['_CFG']['lang'] . '/shopping_flow.php');
            } else {
                $file_path = resource_path('lang/' . $GLOBALS['_CFG']['lang'] . '/user.php');
            }
            ...
            return $this->smarty->display('language_list.dwt');
        }
