...
//        }
        ...
        elseif ($_REQUEST['act'] == 'custom_edit') {
            ...
            $this->smarty->assign('form_act', "custom_update");
    ...
    private function ad_list()
    {
        ...
        if ($result === false) {
            ...
            /* 查询 */
            $sql = "SELECT ad_id, CASE WHEN ad_type = 0 THEN '" . lang('admin/flashplay.img') . "'
                                   WHEN ad_type = 1 THEN '" . lang('admin/flashplay.flash') . "'
                                   WHEN ad_type = 2 THEN '" . lang('admin/flashplay.code') . "'
                                   WHEN ad_type = 3 THEN '" . lang('admin/flashplay.words') . "'
                                   ELSE '' END AS type_name, ad_name, add_time, CASE WHEN ad_status = 1 THEN '" . lang('admin/flashplay.open') . "' ELSE '" . lang('admin/flashplay.close') . "' END AS status_name, ad_type, ad_status
