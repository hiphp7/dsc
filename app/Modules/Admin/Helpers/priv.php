...
$purview['02_admin_seller'] = ['seller_manage', 'seller_drop', 'seller_allot']; //admin_manage_shop
...
if (file_exists($wxapp_file)) {
    $purview['01_wxapp_wechat_config'] = 'wxapp';
    $purview['02_wxapp_template'] = 'template';
    $purview['03_wxapp_ad_position'] = 'wxapp';
}
...
if (file_exists($drp_file)) {
    ...
    $purview['02_drp_card'] = 'drpcard_manage';
    $purview['02_drp_shop'] = 'drp_shop';
    $purview['03_drp_list'] = 'drp_list';
    $purview['04_drp_order_list'] = 'drp_order_list';
    $purview['05_drp_count'] = 'drp_count';
    $purview['06_drp_ad_position'] = 'drp_config';
}
// APP权限
