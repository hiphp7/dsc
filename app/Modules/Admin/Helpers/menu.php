...
if (file_exists($wechat_file)) {
    //微信通菜单
    $modules['22_wechat']['01_wechat_admin'] = 'wechat';
    $modules['22_wechat']['02_mass_message'] = 'wechat/mass_message';
    $modules['22_wechat']['03_auto_reply'] = 'wechat/reply_subscribe';
    $modules['22_wechat']['04_menu'] = 'wechat/menu_list';
    $modules['22_wechat']['05_fans'] = 'wechat/subscribe_list';
    $modules['22_wechat']['06_media'] = 'wechat/article';
    $modules['22_wechat']['07_qrcode'] = 'wechat/qrcode_list';
    $modules['22_wechat']['09_extend'] = 'wechat/extend_index';
    $modules['22_wechat']['10_market'] = 'wechat/market_index';
    $modules['22_wechat']['11_template'] = 'wechat/template';
}

$wxapp_file = app_path('Modules/Admin/Controllers/WxappController.php');
if (file_exists($wxapp_file)) {
    //小程序菜单
    $modules['24_wxapp']['01_wxapp_wechat_config'] = 'wxapp/index';
    $modules['24_wxapp']['02_wxapp_template'] = 'wxapp/template';
    $modules['24_wxapp']['03_wxapp_ad_position'] = 'touch_ad_position.php?act=list&ad_type=wxapp';
}
...
if (file_exists($drp_file)) {
    //微分销菜单
    $modules['23_drp']['01_drp_config'] = 'drp/config';
    $modules['23_drp']['02_drp_card'] = 'drp_card';
    $modules['23_drp']['02_drp_shop'] = 'drp/shop';
    $modules['23_drp']['03_drp_list'] = 'drp/drp_list';
    $modules['23_drp']['04_drp_order_list'] = 'drp/drp_order_list';
    $modules['23_drp']['05_drp_count'] = 'drp/drp_count';
    $modules['23_drp']['06_drp_ad_position'] = 'touch_ad_position.php?act=list&ad_type=drp';
}
...
$menu_top['ectouch'] = '20_ectouch,22_wechat,23_drp,24_wxapp,25_app';//手机
