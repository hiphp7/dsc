    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'edit_replenish') {
            ...
            if ($_POST['card_sn'] != $_POST['old_card_sn']) {
                $sql = "SELECT count(*) FROM " . $this->dsc->table('virtual_card') . " WHERE goods_id='" . $_POST['goods_id'] . "' AND card_sn='$coded_card_sn'";
        ...
        elseif ($_REQUEST['act'] == 'batch_card_add') {
            ...
            $this->smarty->assign('action_link', ['text' => $GLOBALS['_LANG']['virtual_card_list'], 'href' => 'goods.php?act=list&extension_code=virtual_card', 'class' => 'icon-reply']);
            $this->smarty->assign('goods_id', $_REQUEST['goods_id']);
            $this->smarty->assign('menu_select', ['action' => '02_cat_and_goods', 'current' => '01_goods_list']);
        ...
        elseif ($_REQUEST['act'] == 'start_change') {
            ...
            if ($old_key != AUTH_KEY) {
                ...
                $f = storage_public('data/config.php');
