...
$_LANG['label_order_remarks'] = '订单备注：';
...
$_LANG['label_cost_amount'] = '净利润约';
$_LANG['search_logistics_info'] = '正在查询物流信息，请稍后...';
$_LANG['confirm_pay'] = '确定支付吗？';
$_LANG['set_robbing'] = '设置抢单';
$_LANG['wholesale_order_list'] = '采购订单列表';
$_LANG['order_keywords_placeholder'] = '订单编号/商品编号/商品关键字';
$_LANG['download_order'] = '导出订单';
$_LANG['merge_order'] = '合并订单';
$_LANG['not_pay_repeat'] = '不能重复付款！';
...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '显示采购订单列表信息';

$_LANG['operation_prompt_content']['delivery_list'][0] = '供应商已发货的订单列表管理。';
$_LANG['operation_prompt_content']['delivery_list'][1] = '可通过订单号进行查询。';


$_LANG['js_languages']['jl_confirm_pay'] = '确定支付吗？';
$_LANG['js_languages']['jl_set_rob'] = '设置抢单';
$_LANG['js_languages']['jl_consignee_info'] = '收货人信息';
