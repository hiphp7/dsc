...
$_LANG['admin'] = '管理員';
$_LANG['privilege'] = '許可權';
$_LANG['belongs_seller'] = '所屬商家';
$_LANG['seller_admin'] = '商城管理員';

$_LANG['search_user_name'] = '用戶名稱';
...
$_LANG['operation_prompt_content']['list'][0] = '該頁面展示了所有入駐平台的商家管理員列表。';
$_LANG['operation_prompt_content']['list'][1] = '可手動添加管理員並分配許可權、查看日誌等操作。';
$_LANG['operation_prompt_content']['list'][2] = '可以輸入用戶名名稱關鍵字進行搜索，側邊欄可進行高級搜索。';
