...
// 商家後台
$_LANG['team_buy_goods_price'] = '拼團購買時的商品價格（默認本店售價）';
$_LANG['how_many_team'] = '幾人團';
$_LANG['this_team_people_number'] = '此商品的成團人數(不能小於1人團)';
...
$_LANG['js_languages']['jl_team_price_not_null'] = '拼團價格不能爲空！';
$_LANG['js_languages']['jl_team_num_not_null'] = '成團人數不能爲空並且不能小於1人團!';
$_LANG['js_languages']['jl_validity_time_not_null'] = '開團有效期不能爲空寫入時間最好在24小時以內 (時間格式：小時，輸入1~24 數字)';
$_LANG['js_languages']['jl_astrict_num_not_null'] = '限購數量不能爲空！';
$_LANG['js_languages']['jl_select_tc_id'] = '您沒有選拼團頻道!';
