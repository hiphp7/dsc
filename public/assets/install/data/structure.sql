--
-- Table structure for table `dsc_account_log`
--
...
--
-- Table structure for table `dsc_activity_goods_attr`
--
...
--
-- Table structure for table `dsc_ad`
--
...
--
-- Table structure for table `dsc_ad_custom`
--
...
--
-- Table structure for table `dsc_ad_position`
--
...
--
-- Table structure for table `dsc_admin_action`
--
...
--
-- Table structure for table `dsc_admin_log`
--
...
--
-- Table structure for table `dsc_admin_message`
--
...
--
-- Table structure for table `dsc_admin_user`
--
...
CREATE TABLE IF NOT EXISTS `dsc_admin_user` (
  ...
  `todolist` longtext,
  `role_id` smallint(5) DEFAULT NULL DEFAULT '0',
...
--
-- Dumping data for table `dsc_admin_user`
--
...
--
-- Table structure for table `dsc_affiliate_log`
--
...
--
-- Table structure for table `dsc_agency`
--
...
--
-- Table structure for table `dsc_alidayu_configure`
--
...
--
-- Table structure for table `dsc_alitongxin_configure`
--
...
--
-- Table structure for table `dsc_appeal_img`
--
...
--
-- Table structure for table `dsc_area_region`
--
...
--
-- Table structure for table `dsc_article`
--
...
--
-- Table structure for table `dsc_article_cat`
--
...
--
-- Table structure for table `dsc_article_extend`
--
...
--
-- Table structure for table `dsc_attribute`
--
...
--
-- Table structure for table `dsc_attribute_img`
--
...
--
-- Table structure for table `dsc_auction_log`
--
...
--
-- Table structure for table `dsc_auto_manage`
--
...
--
-- Table structure for table `dsc_auto_sms`
--
...
--
-- Table structure for table `dsc_back_goods`
--
...
--
-- Table structure for table `dsc_back_order`
--
...
--
-- Table structure for table `dsc_baitiao`
--
...
--
-- Table structure for table `dsc_baitiao_log`
--
...
--
-- Table structure for table `dsc_baitiao_pay_log`
--
...
--
-- Table structure for table `dsc_bonus_type`
--
...
--
-- Table structure for table `dsc_booking_goods`
--
...
--
-- Table structure for table `dsc_brand`
--
...
--
-- Table structure for table `dsc_brand_extend`
--
...
--
-- Table structure for table `dsc_card`
--
...
--
-- Table structure for table `dsc_cart`
--
...
--
-- Table structure for table `dsc_cart_combo`
--
...
--
-- Table structure for table `dsc_cart_user_info`
--
...
--
-- Table structure for table `dsc_cat_recommend`
--
...
--
-- Table structure for table `dsc_category`
--
...
CREATE TABLE IF NOT EXISTS `dsc_category` (
  ...
  `touch_catads` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `dsc_collect_brand`
--
...
--
-- Table structure for table `dsc_collect_goods`
--
...
--
-- Table structure for table `dsc_collect_store`
--
...
--
-- Table structure for table `dsc_comment`
--
...
--
-- Table structure for table `dsc_comment_baseline`
--
...
--
-- Table structure for table `dsc_comment_img`
--
...
--
-- Table structure for table `dsc_comment_seller`
--
...
--
-- Table structure for table `dsc_complain_title`
--
...
--
-- Table structure for table `dsc_complaint`
--
...
--
-- Table structure for table `dsc_complaint_img`
--
...
--
-- Table structure for table `dsc_complaint_talk`
--
...
--
-- Table structure for table `dsc_connect_user`
--
...
--
-- Table structure for table `dsc_coupons`
--
...
--
-- Table structure for table `dsc_coupons_region`
--
...
--
-- Table structure for table `dsc_coupons_user`
--
...
--
-- Table structure for table `dsc_crons`
--
...
--
-- Table structure for table `dsc_delivery_goods`
--
...
--
-- Table structure for table `dsc_delivery_order`
--
...
--
-- Table structure for table `dsc_discuss_circle`
--
...
--
-- Table structure for table `dsc_email_list`
--
...
--
-- Table structure for table `dsc_email_sendlist`
--
...
--
-- Table structure for table `dsc_entry_criteria`
--
...
--
-- Table structure for table `dsc_error_log`
--
...
--
-- Table structure for table `dsc_exchange_goods`
--
...
--
-- Table structure for table `dsc_favourable_activity`
--
...
--
-- Table structure for table `dsc_feedback`
--
...
--
-- Table structure for table `dsc_floor_content`
--
...
--
-- Table structure for table `dsc_friend_link`
--
...
--
-- Table structure for table `dsc_gallery_album`
--
...
--
-- Table structure for table `dsc_gift_gard_log`
--
...
--
-- Table structure for table `dsc_gift_gard_type`
--
...
--
-- Table structure for table `dsc_goods`
--
...
--
-- Table structure for table `dsc_goods_activity`
--
...
--
-- Table structure for table `dsc_goods_article`
--
...
--
-- Table structure for table `dsc_goods_attr`
--
...
--
-- Table structure for table `dsc_goods_cat`
--
...
--
-- Table structure for table `dsc_goods_change_log`
--
...
--
-- Table structure for table `dsc_goods_conshipping`
--
...
--
-- Table structure for table `dsc_goods_consumption`
--
...
--
-- Table structure for table `dsc_goods_extend`
--
...
--
-- Table structure for table `dsc_goods_gallery`
--
...
CREATE TABLE IF NOT EXISTS `dsc_goods_gallery` (
  ...
  PRIMARY KEY (`img_id`),
  KEY `goods_id` (`goods_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1494 DEFAULT CHARSET=utf8mb4;

--
-- Table structure for table `dsc_goods_inventory_logs`
--
...
--
-- Table structure for table `dsc_goods_lib`
--
...
--
-- Table structure for table `dsc_goods_lib_cat`
--
...
--
-- Table structure for table `dsc_goods_lib_gallery`
--
...
--
-- Table structure for table `dsc_goods_report`
--
...
--
-- Table structure for table `dsc_goods_report_img`
--
...
--
-- Table structure for table `dsc_goods_report_title`
--
...
--
-- Table structure for table `dsc_goods_report_type`
--
...
--
-- Table structure for table `dsc_goods_transport`
--
...
--
-- Table structure for table `dsc_goods_transport_express`
--
...
--
-- Table structure for table `dsc_goods_transport_extend`
--
...
--
-- Table structure for table `dsc_goods_transport_tpl`
--
...
--
-- Table structure for table `dsc_goods_type`
--
...
--
-- Table structure for table `dsc_goods_type_cat`
--
...
--
-- Table structure for table `dsc_group_goods`
--
...
--
-- Table structure for table `dsc_home_templates`
--
...
--
-- Table structure for table `dsc_im_configure`
--
...
--
-- Table structure for table `dsc_im_dialog`
--
...
--
-- Table structure for table `dsc_im_message`
--
...
--
-- Table structure for table `dsc_im_service`
--
...
--
-- Table structure for table `dsc_intelligent_weight`
--
...
--
-- Table structure for table `dsc_jobs`
--
...
--
-- Table structure for table `dsc_kdniao_customer_account`
--
...
--
-- Table structure for table `dsc_kdniao_eorder_config`
--
...
--
-- Table structure for table `dsc_keywords`
--
...
--
-- Table structure for table `dsc_link_area_goods`
--
...
--
-- Table structure for table `dsc_link_brand`
--
...
--
-- Table structure for table `dsc_link_desc_goodsid`
--
...
--
-- Table structure for table `dsc_link_desc_temporary`
--
...
--
-- Table structure for table `dsc_link_goods`
--
...
--
-- Table structure for table `dsc_link_goods_desc`
--
...
--
-- Table structure for table `dsc_mail_templates`
--
...
--
-- Table structure for table `dsc_mass_sms_log`
--
...
--
-- Table structure for table `dsc_mass_sms_template`
--
...
--
-- Table structure for table `dsc_member_price`
--
...
--
-- Table structure for table `dsc_merchants_account_log`
--
...
--
-- Table structure for table `dsc_merchants_category`
--
...
--
-- Table structure for table `dsc_merchants_category_temporarydate`
--
...
--
-- Table structure for table `dsc_merchants_documenttitle`
--
...
--
-- Table structure for table `dsc_merchants_dt_file`
--
...
--
-- Table structure for table `dsc_merchants_goods_comment`
--
...
--
-- Table structure for table `dsc_merchants_grade`
--
...
--
-- Table structure for table `dsc_merchants_nav`
--
...
--
-- Table structure for table `dsc_merchants_percent`
--
...
--
-- Table structure for table `dsc_merchants_privilege`
--
...
--
-- Table structure for table `dsc_merchants_region_area`
--
...
--
-- Table structure for table `dsc_merchants_region_info`
--
...
--
-- Table structure for table `dsc_merchants_server`
--
...
--
-- Table structure for table `dsc_merchants_shop_brand`
--
...
--
-- Table structure for table `dsc_merchants_shop_brandfile`
--
...
--
-- Table structure for table `dsc_merchants_shop_information`
--
...
--
-- Table structure for table `dsc_merchants_steps_fields`
--
...
--
-- Table structure for table `dsc_merchants_steps_fields_centent`
--
...
--
-- Table structure for table `dsc_merchants_steps_img`
--
...
--
-- Table structure for table `dsc_merchants_steps_process`
--
...
--
-- Table structure for table `dsc_merchants_steps_title`
--
...
--
-- Table structure for table `dsc_migrations`
--
...
--
-- Table structure for table `dsc_nav`
--
...
--
-- Table structure for table `dsc_notice_log`
--
...
--
-- Table structure for table `dsc_offline_store`
--
...
--
-- Table structure for table `dsc_open_api`
--
...
--
-- Table structure for table `dsc_order_action`
--
...
--
-- Table structure for table `dsc_order_cloud`
--
...
--
-- Table structure for table `dsc_order_delayed`
--
...
--
-- Table structure for table `dsc_order_goods`
--
...
--
-- Table structure for table `dsc_order_info`
--
...
--
-- Table structure for table `dsc_order_invoice`
--
...
--
-- Table structure for table `dsc_order_print_setting`
--
...
--
-- Table structure for table `dsc_order_print_size`
--
...
--
-- Table structure for table `dsc_order_return`
--
...
--
-- Table structure for table `dsc_order_return_extend`
--
...
--
-- Table structure for table `dsc_oss_configure`
--
...
--
-- Table structure for table `dsc_pack`
--
...
--
-- Table structure for table `dsc_package_goods`
--
...
--
-- Table structure for table `dsc_partner_list`
--
...
--
-- Table structure for table `dsc_pay_card`
--
...
--
-- Table structure for table `dsc_pay_card_type`
--
...
--
-- Table structure for table `dsc_pay_log`
--
...
--
-- Table structure for table `dsc_payment`
--
...
--
-- Table structure for table `dsc_pic_album`
--
...
--
-- Table structure for table `dsc_plugins`
--
...
--
-- Table structure for table `dsc_presale_activity`
--
...
--
-- Table structure for table `dsc_presale_cat`
--
...
--
-- Table structure for table `dsc_products`
--
...
--
-- Table structure for table `dsc_products_area`
--
...
--
-- Table structure for table `dsc_products_changelog`
--
...
--
-- Table structure for table `dsc_products_warehouse`
--
...
--
-- Table structure for table `dsc_qrpay_discounts`
--
...
--
-- Table structure for table `dsc_qrpay_log`
--
...
--
-- Table structure for table `dsc_qrpay_manage`
--
...
--
-- Table structure for table `dsc_qrpay_tag`
--
...
--
-- Table structure for table `dsc_reg_extend_info`
--
...
--
-- Table structure for table `dsc_reg_fields`
--
...
--
-- Table structure for table `dsc_region`
--
...
CREATE TABLE IF NOT EXISTS `dsc_region` (
  ...
  KEY `agency_id` (`agency_id`)
) ENGINE=InnoDB AUTO_INCREMENT=659009509 DEFAULT CHARSET=utf8mb4;

--
-- Table structure for table `dsc_region_backup`
--
...
--
-- Table structure for table `dsc_region_store`
--
...
--
-- Table structure for table `dsc_region_warehouse`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=46515 DEFAULT CHARSET=utf8mb4;

--
-- Table structure for table `dsc_return_action`
--
...
--
-- Table structure for table `dsc_return_cause`
--
...
--
-- Table structure for table `dsc_return_goods`
--
...
--
-- Table structure for table `dsc_return_images`
--
...
--
-- Table structure for table `dsc_role`
--
...
--
-- Table structure for table `dsc_rs_region`
--
...
--
-- Table structure for table `dsc_sale_notice`
--
...
--
-- Table structure for table `dsc_search_keyword`
--
...
--
-- Table structure for table `dsc_searchengine`
--
...
--
-- Table structure for table `dsc_seckill`
--
...
--
-- Table structure for table `dsc_seckill_goods`
--
...
--
-- Table structure for table `dsc_seckill_goods_remind`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='秒杀商品提醒关联表';

--
-- Table structure for table `dsc_seckill_time_bucket`
--
...
--
-- Table structure for table `dsc_seller_account_log`
--
...
--
-- Table structure for table `dsc_seller_apply_info`
--
...
--
-- Table structure for table `dsc_seller_bill_goods`
--
...
--
-- Table structure for table `dsc_seller_bill_order`
--
...
--
-- Table structure for table `dsc_seller_commission_bill`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=6786 DEFAULT CHARSET=utf8mb4;

--
-- Table structure for table `dsc_seller_domain`
--
...
--
-- Table structure for table `dsc_seller_grade`
--
...
--
-- Table structure for table `dsc_seller_qrcode`
--
...
--
-- Table structure for table `dsc_seller_shopbg`
--
...
--
-- Table structure for table `dsc_seller_shopheader`
--
...
--
-- Table structure for table `dsc_seller_shopinfo`
--
...
--
-- Table structure for table `dsc_seller_shopinfo_changelog`
--
...
--
-- Table structure for table `dsc_seller_shopslide`
--
...
--
-- Table structure for table `dsc_seller_shopwindow`
--
...
--
-- Table structure for table `dsc_seller_template_apply`
--
...
--
-- Table structure for table `dsc_seo`
--
...
CREATE TABLE IF NOT EXISTS `dsc_seo` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='SEO信息存放表';

--
-- Table structure for table `dsc_sessions`
--
...
--
-- Table structure for table `dsc_sessions_data`
--
...
--
-- Table structure for table `dsc_shipping`
--
...
--
-- Table structure for table `dsc_shipping_area`
--
...
--
-- Table structure for table `dsc_shipping_date`
--
...
--
-- Table structure for table `dsc_shipping_point`
--
...
--
-- Table structure for table `dsc_shipping_tpl`
--
...
--
-- Table structure for table `dsc_shop_config`
--
...
--
-- Table structure for table `dsc_single`
--
...
--
-- Table structure for table `dsc_single_sun_images`
--
...
--
-- Table structure for table `dsc_snatch_log`
--
...
--
-- Table structure for table `dsc_solve_dealconcurrent`
--
...
--
-- Table structure for table `dsc_source_ip`
--
...
--
-- Table structure for table `dsc_stages`
--
...
--
-- Table structure for table `dsc_stats`
--
...
--
-- Table structure for table `dsc_store_action`
--
...
--
-- Table structure for table `dsc_store_back_order`
--
...
--
-- Table structure for table `dsc_store_goods`
--
...
--
-- Table structure for table `dsc_store_order`
--
...
--
-- Table structure for table `dsc_store_products`
--
...
--
-- Table structure for table `dsc_store_user`
--
...
--
-- Table structure for table `dsc_suppliers`
--
...
--
-- Table structure for table `dsc_tag`
--
...
--
-- Table structure for table `dsc_team_category`
--
...
--
-- Table structure for table `dsc_team_goods`
--
...
--
-- Table structure for table `dsc_team_log`
--
...
--
-- Table structure for table `dsc_template`
--
...
--
-- Table structure for table `dsc_template_mall`
--
...
--
-- Table structure for table `dsc_templates_left`
--
...
--
-- Table structure for table `dsc_temporary_files`
--
...
--
-- Table structure for table `dsc_topic`
--
...
--
-- Table structure for table `dsc_touch_ad`
--
...
--
-- Table structure for table `dsc_touch_ad_position`
--
...
--
-- Table structure for table `dsc_touch_adsense`
--
...
--
-- Table structure for table `dsc_touch_auth`
--
...
--
-- Table structure for table `dsc_touch_nav`
--
...
--
-- Table structure for table `dsc_touch_page_view`
--
...
--
-- Table structure for table `dsc_touch_topic`
--
...
--
-- Table structure for table `dsc_touch_upgrade`
--

DROP TABLE IF EXISTS `dsc_touch_upgrade`;
CREATE TABLE IF NOT EXISTS `dsc_touch_upgrade` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `upgrade` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8_unicode_ci;

--
-- Table structure for table `dsc_trade_snapshot`
--
...
--
-- Table structure for table `dsc_user_account`
--
...
--
-- Table structure for table `dsc_user_account_fields`
--
...
--
-- Table structure for table `dsc_user_address`
--
...
--
-- Table structure for table `dsc_user_bank`
--
...
--
-- Table structure for table `dsc_user_bonus`
--
...
--
-- Table structure for table `dsc_user_feed`
--
...
--
-- Table structure for table `dsc_user_gift_gard`
--
...
--
-- Table structure for table `dsc_user_rank`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=3044 DEFAULT CHARSET=utf8mb4;

--
-- Table structure for table `dsc_users_auth`
--
...
--
-- Table structure for table `dsc_users_log`
--
...
--
-- Table structure for table `dsc_users_paypwd`
--
...
--
-- Table structure for table `dsc_users_real`
--
...
--
-- Table structure for table `dsc_users_type`
--
...
--
-- Table structure for table `dsc_users_vat_invoices_info`
--
...
--
-- Table structure for table `dsc_value_card`
--
...
--
-- Table structure for table `dsc_value_card_record`
--
...
--
-- Table structure for table `dsc_value_card_type`
--
...
--
-- Table structure for table `dsc_virtual_card`
--
...
--
-- Table structure for table `dsc_volume_price`
--
...
--
-- Table structure for table `dsc_vote`
--
...
--
-- Table structure for table `dsc_vote_log`
--
...
--
-- Table structure for table `dsc_vote_option`
--
...
--
-- Table structure for table `dsc_warehouse_area_attr`
--
...
--
-- Table structure for table `dsc_warehouse_area_goods`
--
...
--
-- Table structure for table `dsc_warehouse_attr`
--
...
--
-- Table structure for table `dsc_warehouse_freight`
--
...
--
-- Table structure for table `dsc_warehouse_freight_tpl`
--
...
--
-- Table structure for table `dsc_warehouse_goods`
--
...
--
-- Table structure for table `dsc_wholesale`
--
...
--
-- Table structure for table `dsc_wholesale_cart`
--
...
--
-- Table structure for table `dsc_wholesale_cat`
--
...
--
-- Table structure for table `dsc_wholesale_extend`
--
...
CREATE TABLE IF NOT EXISTS `dsc_wholesale_extend` (
  ...
  PRIMARY KEY (`extend_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='限时批发标识';

--
-- Table structure for table `dsc_wholesale_goods_attr`
--
...
--
-- Table structure for table `dsc_wholesale_order_action`
--
...
--
-- Table structure for table `dsc_wholesale_order_goods`
--
...
--
-- Table structure for table `dsc_wholesale_order_info`
--
...
--
-- Table structure for table `dsc_wholesale_products`
--
...
--
-- Table structure for table `dsc_wholesale_purchase`
--
...
--
-- Table structure for table `dsc_wholesale_purchase_goods`
--
...
--
-- Table structure for table `dsc_wholesale_volume_price`
--
...
--
-- Table structure for table `dsc_zc_category`
--
...
--
-- Table structure for table `dsc_zc_focus`
--
...
--
-- Table structure for table `dsc_zc_goods`
--
...
--
-- Table structure for table `dsc_zc_initiator`
--
...
--
-- Table structure for table `dsc_zc_progress`
--
...
--
-- Table structure for table `dsc_zc_project`
--
...
--
-- Table structure for table `dsc_zc_rank_logo`
--
...
--
-- Table structure for table `dsc_zc_topic`
--
