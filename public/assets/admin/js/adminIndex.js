$(function(){
		...
		$("div.bgSelector").toggle(300, function() {
			if ($(this).html() == '') {
				$(this).sColor({
					...
					curImg: '../assets/admin/images/cur.png',  //必填，颜色选择对象图片路径
    ...
    Ajax.call('index.php?is_ajax=1&act=check_order','', function(data){
		...
		//供应商提醒 start
		var suppliers = data.suppliers ? data.suppliers :0;//未审核供应商
		var suppliers_goods = data.suppliers_goods ? data.suppliers_goods :0; //未审核供应商商品
		//供应商提醒 end
...
+parseInt(shop_account)+parseInt(shopinfo_account)+parseInt(seller_account)+parseInt(wait_cash)+parseInt(wait_balance)+parseInt(wait_recharge)+parseInt(seller_apply)+parseInt(advance_date)+parseInt(user_account)+parseInt(user_recharge)+parseInt(user_withdraw)+parseInt(user_vat)+parseInt(user_discuss)+parseInt(snatch)+parseInt(bonus_type)+parseInt(group_by)+parseInt(topic)+parseInt(auction)+parseInt(favourable)+parseInt(presale)+parseInt(package_goods)+parseInt(exchange_goods)+parseInt(coupons)+parseInt(gift_gard)+parseInt(seckill)+parseInt(suppliers)+parseInt(suppliers_goods);
		...
		//活动提示
		var campaign_total = parseInt(snatch)+parseInt(bonus_type)+parseInt(group_by)+parseInt(topic)+parseInt(auction)+parseInt(favourable)+parseInt(presale)+parseInt(package_goods)+parseInt(exchange_goods)+parseInt(coupons)+parseInt(gift_gard)+parseInt(seckill);
		if(campaign_total >0){
		...
		//供货商提示
		var suppliers_total = parseInt(suppliers)+parseInt(suppliers_goods);
        if(suppliers_total >0){
            $('.suppliers_msg').after('<s id="total">'+suppliers_total+'</s>');
        }else{
            $('.suppliers_msg').after('<s id="total">0</s>');
        }
        ...
        if(total != 0){
			//订单提醒 start
				...
				if(complaint>=0 && complaint<100){
					$("*[ectype='orderMsg']").append('<p><a href="javascript:void(0);" data-url="complaint.php?act=list&handle_type=6" data-param="menushopping|13_complaint" target="workspace" class="message" >交易纠纷</a> <span class="tiptool">（<em id="no_change">'+complaint+'</em>）</span></p>')
				}else if(complaint>99){
					$("*[ectype='orderMsg']").append('<p><a href="javascript:void(0);" data-url="complaint.php?act=list&handle_type=6" data-param="menushopping|13_complaint" class="message" >交易纠纷</a><span class="tiptool">（<em id="no_change">99+</em>）</span></p>')
				}
				//待处理投诉订单 end
			...
			//商家提醒 start
				...
				if(wait_balance >= 0  && wait_balance<100){
                    $("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="merchants_commission.php?act=commission_bill&bill_apply=1" data-param="menushopping|12_seller_account" target="workspace" class="message">待审核商家结算</a> <span class="tiptool">（<em id="seller_account">'+wait_balance+'</em>）</span></p>')
				}else if(wait_balance > 99){
					$("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="merchants_commission.php?act=commission_bill&bill_apply=1" data-param="menushopping|12_seller_account" target="workspace" class="message">待审核商家结算</a><span class="tiptool">（<em id="seller_account">99+</em>）</span></p>')
				}
				//待审核商家结算 end

				//待审核商家充值 start
				if(wait_recharge >= 0  && wait_recharge<100){
					$("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="merchants_account.php?act=list&act_type=detail&log_type=3&handler=2" data-param="menushopping|12_seller_account" target="workspace" class="message">待审核商家充值</a> <span class="tiptool">（<em id="seller_account">'+wait_recharge+'</em>）</span></p>')
				}else if(wait_recharge > 99){
					$("*[ectype='sellerMsg']").append('<p><a href="javascript:void(0);" data-url="merchants_account.php?act=list&act_type=detail&log_type=3&handler=2" data-param="menushopping|12_seller_account" target="workspace" class="message">待审核商家充值</a><span class="tiptool">（<em id="seller_account">99+</em>）</span></p>')
				}
				//待审核商家充值 end
			...
			//会员提醒 start
				...
				if(user_discuss >= 0  && user_discuss<100){
					$("*[ectype='userMsg']").append('<p><a href="javascript:void(0);" data-url="discuss_circle.php?act=list&review_status=1" target="workspace" class="message">网友讨论圈审核</a> <span class="tiptool">（<em id="user_discuss">'+user_discuss+'</em>）</span></p>')
				}else if(user_discuss > 99){
					$("*[ectype='userMsg']").append('<p><a href="javascript:void(0);" data-url="discuss_circle.php?act=list&review_status=1" target="workspace" class="message">网友讨论圈审核</a><span class="tiptool">（<em id="user_discuss">99+</em>）</span></p>')
				}
				//网友讨论圈审核 end
			//会员提醒 end
			...
			//供货商提醒 start
				//未审核供货商 start
				if(suppliers >= 0  && suppliers<100){
					$("*[ectype='suppliersMsg']").append('<p><a href="javascript:void(0);" data-url="suppliers.php?act=list&review_status=1" data-param="suppliers|01_suppliers_list" target="workspace" class="message">未审核供应商</a> <span class="tiptool">（<em id="user_account">'+suppliers+'</em>）</span></p>')
				}else if(suppliers > 99){
					$("*[ectype='suppliersMsg']").append('<p><a href="javascript:void(0);" data-url="suppliers.php?act=list&review_status=1" data-param="suppliers|01_suppliers_list" target="workspace" class="message">未审核供应商</a><span class="tiptool">（<em id="user_account">99+</em>）</span></p>')
				}
				//未审核供货商 end
				//未审核供货商商品 start
				if(suppliers_goods >= 0  && suppliers_goods<100){
					$("*[ectype='suppliersMsg']").append('<p><a href="javascript:void(0);" data-url="wholesale.php?act=list&review_status=1" data-param="suppliers|01_wholesale" target="workspace" class="message">未审核供应商品</a> <span class="tiptool">（<em id="user_account">'+suppliers_goods+'</em>）</span></p>')
				}else if(suppliers_goods > 99){
					$("*[ectype='suppliersMsg']").append('<p><a href="javascript:void(0);" data-url="wholesale.php?act=list&review_status=1" data-param="suppliers|01_wholesale" target="workspace" class="message">未审核供应商品</a><span class="tiptool">（<em id="user_account">99+</em>）</span></p>')
				}
				//未审核供货商商品 end
			//供货商提醒 end
        }else{
