...
listTable_pb.edit = function(obj, act, id)
{
  ...
  txt.onblur = function(e)
  {
    ...
    {
      res = Ajax.call(listTable_pb.url, "act="+act+"&val=" + encodeURIComponent(Utils.trim(txt.value)) + "&id=" +id, null, "POST", "JSON");
...
listTable_pb.editInput = function(obj, act, id, val, str)
{
    ...
    {
      res = Ajax.call(listTable_pb.url, "act="+act+"&val=" + encodeURIComponent(Utils.trim(value)) + "&id=" +id + type, null, "POST", "JSON");
