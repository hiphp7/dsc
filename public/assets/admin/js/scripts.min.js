...
jQuery(function($){
	...
	visualShell.on("click","*[ectype='model_edit']",function(){
		...
		switch(purebox){
			...
			case "goods":
				...
				//商品模块编辑
				spec_attr = JSON.stringify(spec_attr);
                Ajax.call('dialog.php', "act=goods_info" + "&mode=" + mode + "&diff=" + diff + "&spec_attr=" + encodeURIComponent(spec_attr) + "&lift=" + lift + "&current_url=" + url , query_goods, 'POST', 'JSON');
			break;
		}
	});
	...
	$(document).on("click","*[ectype='setupGoods']",function(){
		...
		Ajax.call('dialog.php', "act=goods_info" + "&goods_type=1&cat_id=" + cat_id + "&spec_attr="+$.toJSON(spec_attr) + "&good_number=" + good_number + "&current_url=" + url, function(data){
