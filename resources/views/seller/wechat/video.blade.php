                    ...
                    <div class="tab-content">
                        <div class="tab-pane active">
                            <div class="common-head mt20">
                                <div class="fl mb20">
                                    <a href="{{ route('seller/wechat/video_edit') }}"
                                       class="sc-btn sc-blue-btn"><span><i class="fa fa-plus"></i>{{ $lang['video_add'] }}</span></a>
                                </div>
                            </div>
                            <div class="clear"></div>
                                    ...
                                    @foreach($list as $v)
                                        ...
                                        <li class="picture-add" style="">
                                            <div class="picture-add-top">
                                                <img alt="{{ $v['file_name'] }}" src="{{ asset('img/video.png') }}"
                                            ...
                                            <div class="operate threebtn">
                                                ...
                                                <a href="{{ route('seller/wechat/video_edit', array('id'=>$v['id'])) }}"
                                                   title="{{ $lang['edit'] }}" class="ectouch-fs18 fancybox"><span
