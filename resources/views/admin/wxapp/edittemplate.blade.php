...
<div class="panel panel-default" style="margin:0;">
    ...
    <div class="flexilist of">
        <div class="common-content of">
            <div class="main-info">
                <form action="{{ route('admin/wxapp/edit_template') }}" method="post" class="form-horizontal"
                    ...
                    <div id="general-table" class="switch_info ">
                        <div class="item">
                            ...
                            <div class="label_value">
                                <input type="text" class="text" value="{{ $template['wx_title'] ?? '' }}" disabled
                                       readonly/>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="label_value">
                                <input type="text" class="text" value="{{ $template['wx_code'] ?? '' }}" disabled
                                       readonly/>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="label_value">
                                <textarea class="textarea" name="data[wx_content]"
                                          rows="5">{{ $template['wx_content'] ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="item">
...
<script type="text/javascript">
    $(function () {
        $('input[type="submit"]').click(function () {
            ...
            $.post("{{ route('admin/wxapp/edit_template') }}", ajax_data, function (data) {
                if (data.status > 0) {
