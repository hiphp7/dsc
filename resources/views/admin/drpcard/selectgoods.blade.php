                ...
                <div class="goods_search_div bor_bt_das">
                    <div class="search_select">
                        <div class="categorySelect">
                            <div class="selection">
                                <input type="text" name="category_name" id="category_name" class="text w250 valid" value="{{ lang('admin/team.please_category') }}" autocomplete="off" readonly="" data-filter="cat_name">
                                <input type="hidden" name="category_id" id="category_id" value="0" data-filter="cat_id">
                            </div>
                            <div class="select-container" style="display: none;">
                                <!--分类搜索-->
                                <div class="select-top">
                                    <a href="javascript:;" class="categoryTop" data-cid="0" data-cname="">{{ lang('admin/team.choose_again') }}</a>
                                    ...
                                    @else
                                        ...
                                        &gt; <span>{{ lang('admin/team.please_category') }}</span>
                    ...
                    <div class="search_select">
                        <div class="brandSelect">
                            <div class="selection">
                                <input type="text" name="brand_name" id="brand_name" class="text w120 valid" value="{{ lang('admin/team.choose_brand') }}" autocomplete="off" readonly="" data-filter="brand_name">
                            ...
                            <div class="brand-select-container" style="display: none;">
                                <div class="brand-top">
                                    <div class="letter">
                                        <ul>
                                            <li><a href="javascript:void(0);" data-letter="">{{ lang('admin/team.all_brand') }}</a></li>
                                            ...
                                            <li><a href="javascript:void(0);" data-letter="QT">{{ lang('admin/team.other') }}</a></li>
                                        </ul>
                                    </div>
                                    <div class="b_search">
                                        <input name="search_brand_keyword" id="search_brand_keyword" type="text" class="b_text" placeholder="{{ lang('admin/team.search_brand') }} " autocomplete="off">
                                ...
                                <div class="brand-list ps-container ps-active-y">
                                    ...
                                    <ul>
                                        <li data-id="0" data-name="{{ lang('admin/team.choose_brand') }}" class="blue">{{ lang('admin/team.choose_cancel') }}</li>
                                ...
                                <div class="brand-not" style="display:none;">{{ lang('admin/team.no_brand_records') }}</div>
                            </div>
                        </div>
                    </div>
