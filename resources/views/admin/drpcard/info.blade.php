...
<div class="wrapper">
	<div class="title"><a href="{{ route('admin/drp_card/index') }}" class="s-back">{{ lang('common.back') }}</a> {{ lang('admin/drp.drp_manage') }} - {{ lang('admin/drpcard.drp_card') }}</div>
                    ...
                    <div class="switch_info add-rights">
                        ...
                        <div class="item">
                            ...
                            <div class="label_value">
                                <input type="text" name="data[name]" disabled class="form-control w350 card-title" value="{{ $info['name'] ?? '' }}"/>
                            </div>
                        </div>
                            ...
                            <div class="label_value">
                                ...
                                <div class="checkbox_items">
                                    <div class="checkbox_item">
                                        <input type="radio" name="background" disabled class="ui-radio event_zhuangtai" id="value_background_0" value="0"
                                               @if((isset($info['background']) && empty($info['background'])) || !isset($info['background']))
                                               checked
                                                @endif
                                        >
                                        <label for="value_background_0" disabled class="ui-radio-label  flex pl30
												@if((isset($info['background']) && empty($info['background'])) || !isset($info['background']))
                                                active
                                                @endif
                                                " style="width: 200px;">
                                            <div id="font_color" class="font_color mr10 w300">
                                                <input type='text' id="full" disabled value="{{ $info['background_color'] ?? ''}}" style="display:none"/>
                                            </div>
                                            <input type="hidden" id="text_color" name="background_color" disabled value="{{ $info['background_color'] ?? '#efccc6' }}">
                                        </label>
                                    </div>
                                    <div class="checkbox_item">
                                        <input type="radio" name="background" disabled class="ui-radio event_zhuangtai" id="value_background_1" value="1"
                                               @if(isset($info['background']) && $info['background'] == 1)
                                               checked
                                                @endif
                                        >
                                        <label for="value_background_1" class="ui-radio-label flex pl30
                                            ...
                                            <div class="type-file-box w600">
                                                ...
                                                <span class="ml10 js-remove-img"><i class="fa fa-trash-o"></i></span>
                                                @endif
                        ...
                        <div class="item">
                            ...
                            <div class="label_value">
                                <div class="checkbox_items">
                                    <div class="checkbox_item">
                                        <input type="radio" name="data[expiry_type]" disabled class="ui-radio event_zhuangtai" id="value_expiry_type_0" value="forever"
                                    ...
                                    <div class="checkbox_item">
                                        <input type="radio" name="data[expiry_type]" disabled class="ui-radio event_zhuangtai" id="value_expiry_type_1" value="days"
                                        ...
                                        <label for="value_expiry_type_1" class="ui-radio-label
                                            ...
                                            <input type="number" min="1" step="1" name="data[expiry_date]" disabled value="{{ $info['expiry_date'] ?? '' }}" class="form-control w100 input-sm">
                                            {{ lang('admin/drpcard.expiry_type_days_part') }}
                                        </label>
                                    </div>
                                    <div class="checkbox_item">
                                        <input type="radio" name="data[expiry_type]" disabled class="ui-radio event_zhuangtai" id="value_expiry_type_2" value="timespan"                           @if(isset($info['expiry_type']) && $info['expiry_type'] == 'timespan')
                                               checked
                                            @endif
                                        >
                                        <label for="value_expiry_type_2" class="ui-radio-label fl
                                            ...
                                            <div id="text_time1" class="text_time">
                                                <input type="text" class="text expiry_date" name="expiry_date[]" disabled id="expiry_date_start" value="{{ $info['expiry_date_start'] ?? ''}}" placeholder="{{ lang('admin/drpcard.expiry_date_start') }}" autocomplete="off" readonly />
                                            </div>
                                            <span class="bolang">{{ lang('admin/drpcard.to') }}</span>
                                            <div id="text_time2" class="text_time">
                                                <input type="text" class="text expiry_date" name="expiry_date[]" disabled id="expiry_date_end" value="{{ $info['expiry_date_end'] ?? ''}}" placeholder="{{ lang('admin/drpcard.expiry_date_end') }}" autocomplete="off" readonly />
                                            </div>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="label_value ">
                                <div class="checkbox_items">
                                    ...
                                    @if(isset($receive_type_checkbox) && !empty($receive_type_checkbox))
                                        ...
                                        <div class="checkbox_item">
                                            <input type="checkbox" name="receive_type[]" disabled class="checkbox" disabled id="value_receive_type_{{ $value['type'] }}" value="{{ $value['type'] }}"
                                                   @if(isset($value['is_checked']) && $value['is_checked'] == '1')
                                                   checked
                                                    @endif
                                            >
                                            <label for="value_receive_type_{{ $value['type'] }}" disabled class="checkbox_stars
                                                @if(isset($value['is_checked']) && $value['is_checked'] == '1')
                                                active
                                                @endif
                                                ...
                                                @if(isset($value['type']) && $value['type'] == 'goods')
                                                    ...
                                                    <input type="hidden" disabled name="input_value_old[{{ $value['type'] }}]" class="form-control w250 input-sm" value="{{ $value['value'] ?? ''}}"  />
                                                ...
                                                @else
                                                    ...
                                                    @if(isset($value['type']) && $value['type'] == 'free')
                                                        <input type="hidden" disabled name="input_value[{{ $value['type'] }}]"  />
                                                    @else
                                                    ...
                                                    <input type="number"
                                                       ...
                                                       name="input_value[{{ $value['type'] }}]" disabled class="form-control w250 input-sm"  value="{{ $value['value'] ?? ''}}" autocomplete="off" placeholder="{{ lang('admin/drpcard.placeholder_for_' . $value['type']) }}" />
                        ...
                        <div class="item">
                            ...
                            <div class="label_value">
                                <textarea name="data[description]" disabled rows="5" class="form-control w350">{{ $info['description'] ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="label_value">
                                <input type="number" name="data[sort]" disabled class="form-control w100" value="{{ $info['sort'] ?? '50' }}">
                            </div>
                        </div>
                        ...
                        <div class="item hide">
                            ...
                            <div class="label_value">
                                <input type="text" name="data[enable]" disabled class="form-control w100" value="1">
                            </div>
                        </div>
                                    ...
                                    @foreach($rights_list as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td class="handle">
                                                <div class="tDiv">
                                                    @if($value['enable'] == 1)
                                                        <a href="javascript:;" class="btn_edit disabled"><i class="fa fa-edit"></i>{{ lang('admin/common.edit') }}</a>
                                                    @else
                                                    ...
                                                    @endif
                                                    <a href="javascript:;"  class="btn_trash disabled"><i class="fa fa-trash-o"></i>{{ lang('admin/common.drop') }}</a>
                                                </div>
                                            </td>
                                        </tr>
