...
<div class="fancy">
    <div class="title">{{ $lang['tag_add'] }}/{{ $lang['tag_edit'] }}</div>
    <div class="flexilist of">
    		<div class="main-info">
				<form action="{{ route('admin/wechat/tags_edit') }}" method="post" class="form-horizontal" role="form" onsubmit="return false;">
                    @csrf
...
$(function(){
	$(".form-horizontal").submit(function(){
		...
		$.post("{{ route('admin/wechat/tags_edit') }}", ajax_data, function(data){
		    if(data.status > 0){
