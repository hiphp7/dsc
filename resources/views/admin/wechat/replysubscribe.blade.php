...
<div class="wrapper">
    ...
    <div class="content_tips">
        <div class="tabs_info">
            <ul>
                <li class="curr"><a
                            href="{{ route('admin/wechat/reply_subscribe') }}">{{ $lang['subscribe_autoreply'] }}</a>
                </li>
        ...
        <div class="flexilist">
            <div class="main-info">
                <form action="{{ route('admin/wechat/reply_subscribe') }}" method="post">
...
@if(empty($subscribe) || (isset($subscribe['content']) && $subscribe['content']))
                                ...
                                @if(isset($subscribe['media']) && $subscribe['media'])
                                    ...
                                    @if(isset($subscribe['media']['type']) && $subscribe['media']['type'] == 'voice')
                                        ...
                                        <input type='hidden' name='media_id' value="{{ $subscribe['media_id'] }}"><img
                                    ...
                                    @else
                                        ...
                                        <input type='hidden' name='media_id' value="{{ $subscribe['media_id'] }}"><img
                                                src="{{ $subscribe['media']['file'] }}" class='img-rounded'/>
