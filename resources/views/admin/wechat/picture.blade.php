...
<div class="wrapper">
    ...
    <div class="content_tips">
        <div class="tabs_info">
            <ul>
                ...
                <li role="presentation" class="curr"><a
                            href="{{ route('admin/wechat/picture') }}">{{ $lang['picture'] }}</a></li>
        ...
        <div class="flexilist">
            <form action="{{ route('admin/wechat/picture') }}" method="post" enctype="multipart/form-data" id="picForm">
                @csrf
                <div class="form-group of">
                    <div class="type-file-box">
                        <a href="javascript:;" class="type-file-button updata_pic" style="margin-right:20px;"></a>
            ...
            <div class="row" style="margin:0;">
                ...
                @foreach($list as $v)
                    ...
                    <div class="col-xs-4 col-md-2 col-lg-2 thumbnail" style="margin-right:10px;">
                        <img alt="{{ $v['file_name'] }}" src="{{ $v['file'] }}" class="img-rounded"
                             style="height:220px"/>
                                        ...
                                        <a href="javascript:;" title="{{ $lang['disabled_drop'] }}"
                                           class="ectouch-fs18">
                                            ...
                                            @else
                                                ...
                                                <a href="javascript:if(confirm('{{ $lang['confirm_delete'] }}')){window.location.href='{{ route('admin/wechat/media_del', array('id'=>$v['id'])) }}'};"
