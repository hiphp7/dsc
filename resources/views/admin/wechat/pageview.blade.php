<div class="list-page">
    <div id="turn-page">
        ...
        <span class="page page_3"><i>{{ lang('admin/common.page_size') }}</i><input type="text" size="3" id="pageSize" value="{{ $page_num }}" onkeypress="return changePageSize(event);"></span>
        <span id="page-link">
	        <a href="
            ...
            javascript:;
            @endif
                    " class="first" title="{{ lang('admin/common.page_first') }}"></a>
	        <a href="
            ...
            javascript:;
            @endif
                    " class="prev" title="{{ lang('admin/common.page_prev') }}"></a>
            ...
            @else
                    javascript:;
                    @endif
                    " class="next" title="{{ lang('admin/common.page_next') }}"></a>
	        <a href="
            ...
            @else
                    javascript:;
                    @endif
                    " class="last" title="{{ lang('admin/common.page_last') }}"></a>
	    </span>
    </div>
</div>
