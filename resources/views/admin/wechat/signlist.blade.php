...
<div class="wrapper">
    <div class="title"><a href="{{ route('admin/wechat/extend_index') }}"
                          class="s-back">{{ $lang['back'] }}</a> {{ $lang['sign_list'] }}
    </div>
    <div class="content_tips">
        <div class="explanation" id="explanation">
            ...
            <ul>
                @if(isset($lang['sign_list_tips']) && !empty($lang['sign_list_tips']))

                    @foreach($lang['sign_list_tips'] as $v)
                        <li>{{ $v }}</li>
                    @endforeach
        ...
        <div class="flexilist">
            <div class="common-head">
                ...
                <div class="fl">
                    <form action="{{ route('admin/wechat/export_sign', array('ks' => $activity_type)) }}" method="post">
                ...
                <div class="search">
                    <form action="{{ route('admin/wechat/sign_list', array('ks' => $activity_type)) }}"
                ...
                <div class="list-div" id="min-h300">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            ...
                            <th>
                                <div class="tDiv">{{ $lang['sign_time'] }}</div>
                            </th>
                            <th>
                                <div class="tDiv">{{ $lang['sign_prize'] }}</div>
                            </th>
                            <th>
                                <div class="tDiv">{{ $lang['sign_remark'] }}</div>
                            </th>
                            <th width="10%">
                        ...
                        @if(!empty($list))
                            ...
                            @foreach($list as $val)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tDiv">{{ $val['createtime_format'] }}</div>
                                    </td>
                                    <td>
                                        <div class="tDiv">{{ $val['sign_prize'] ?? '' }}</div>
                                    </td>
                                    <td>
                                        <div class="tDiv">{{ $val['change_desc'] ?? '' }}</div>
                                    </td>
                                    <td class="handle">
                                        <div class="tDiv a3">
                                            <a href="javascript:if(confirm('{{ $lang['confirm_delete'] }}'))window.location.href='{{ route('admin/wechat/sign_del', array('id'=>$val['id'], 'ks'=>$activity_type)) }}';"
