...
<div class="panel panel-default" style="margin:0;">
    ...
    <div class="panel-footer">
        ...
        <div class="info_btn of">
            <input type="submit" value="{{ $lang['button_submit'] }}" class="button btn-danger bg-red confrim"
                   name="file_submit"/>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".confrim").click(function () {
            ...
            $.post("{{ route('admin/wechat/get_article') }}", {article: formArticleDate}, function (data) {
                if (data.length > 0) {
                    var str = '';
