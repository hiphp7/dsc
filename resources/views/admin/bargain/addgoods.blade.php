...
<div class="wrapper">
    <div class="title">{{ $lang['bargain_menu'] }} - {{ $lang['bargain_goods_add'] }}</div>
    <div class="content_tips">
        <div class="explanation" id="explanation">
            ...
            <ul>
                @if(isset($lang['bargain_goods_add_tips']) && !empty($lang['bargain_goods_add_tips']))

                    @foreach($lang['bargain_goods_add_tips'] as $v)
                        <li>{!! $v !!}</li>
                    @endforeach
        ...
        <div class="flexilist">
            <div class="main-info">
                ...
                <form method="post" action="{{ route('admin/bargain/addgoods') }}" enctype="multipart/form-data"
                    ...
                    <div class="switch_info">
                        ...
                        <div class="goods_search_div bor_bt_das">
                                ...
                                <div class="categorySelect">
                                    <div class="selection">
                                        <input type="text" name="category_name" id="category_name"
                                               class="text w250 valid" value="{{ $lang['choose_category'] }}"
                                    ...
                                    <div class="select-container" style="display: none;">
                                        ...
                                        <div class="select-top">
                                            ...
                                            @else
                                                ...
                                                &gt; <span>{{ $lang['choose_category'] }}</span>
                            ...
                            <div class="search_select">
                                <div class="brandSelect">
                                    ...
                                    <div class="brand-select-container" style="display: none;">
                                        ...
                                        <div class="brand-list ps-container ps-active-y">
                                            ...
                                            <ul>
                                                <li data-id="0" data-name="{{ $lang['choose_brand'] }}"
                                                    class="blue">{{ $lang['choose_brand'] }}</li>
                                        ...
                                        <div class="brand-not" style="display:none;">{{ $lang['no_brand_records'] }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="text" name="keyword" class="text w150"
                                   placeholder="{{ $lang['search_goods'] }}"
                                   data-filter="keyword" autocomplete="off">
                            <a href="javascript:void(0);" class="btn btn30" onclick="searchGoods()"><i
                                        class="fa fa-search"></i>{{ $lang['search_goods'] }}</a>
                        </div>
                        <div class="item">
                            <div class="label-t">{{ $lang['bargain_goods'] }}</div>
                            <div class="label_value">
                                <div id="goods_id" class="imitate_select select_w320">
                                    ...
                                    <input name="data[goods_id]" type="hidden" datatype="*"
                                           nullmsg="{{ $lang['please_choose_goods'] }}" value="
@if(isset($info['id']) && $info['id'])
                                    {{ $info['goods_id'] }}
                                    @endif
                                            " id="goods_id_val">
                    ...
                    <!-- <div class="item " >
                        ...
                        <div class="item goods_price">
                            <div class="label-t">{{ $lang['bargain_goods_price'] }}</div>
                            <div class="label_value">
                                <input type="text" id="goods_price" name="data[goods_price]"
                                       nullmsg="{{ $lang['bargain_goods_price_empty'] }}"
                                       class="text" readonly value="{{ $info['goods_price'] ?? '' }}">
                                <p class="notic"></p>
                            </div>
                        </div>
                        <div class="item target_price">
                            <div class="label-t">{{ $lang['bargain_target_price'] }}</div>
                            <div class="label_value">
                                <input type="text" id="target_price" name="data[target_price]"
                                       nullmsg="{{ $lang['bargain_target_price_empty'] }}"
                                       class="text" value="{{ $info['target_price'] ?? '' }}">
                                <p class="notic">{{ $lang['bargain_target_price_notice'] }}</p>
                            </div>
                        </div>
                        <div class="item ">
                            <div class="label-t">{{ $lang['bargain_start_time'] }}</div>
                            <div class="label_value">
                                <div class="text_time" id="text_time1" style="float:left;">
                                    <input type="text" name="data[start_time]" class="text"
                                           value="{{ $info['start_time'] ?? '' }}" id="promote_start_date" readonly>
                                </div>
                        ...
                        <div class="item ">
                            <div class="label-t">{{ $lang['bargain_end_time'] }}</div>
                            <div class="label_value">
                                <div class="text_time" id="text_time2" style="float:left;">
                                    <input type="text" name="data[end_time]" class="text"
                                           value="{{ $info['end_time'] ?? '' }}" id="promote_end_date" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="label-t">{{ $lang['bargain_section'] }}</div>
                            <div class="label_value">
                                <table class="table_div table_heng">
                                    <tbody>
                                    <tr class="first_tr">
                                        <td><input type="text" name="data[min_price]"
                                                   value="{{ $info['min_price'] ?? '' }}" class="text new-text w50"
                                                   autocomplete="off"></td>
                                        <td class="first_td w70">{{ $lang['min_value'] }}</td>
                                    </tr>
                                    <tr class="first_tr">
                                        <td><input type="text" name="data[max_price]"
                                                   value="{{ $info['max_price'] ?? '' }}" class="text new-text w50"
                                                   autocomplete="off"></td>
                                ...
                                <p class="notic">{{ $lang['bargain_section_notice'] }}</p>
                            </div>
                        </div>

                        <!--属性显示-->
                        <div class="item">
                            <div class="" id="tbody-goodsAttr"></div>
                            <div class="" id="attribute_table"></div>
                        </div>

                        <div class="item">
                            <div class="label-t">{{ $lang['is_hot'] }}</div>
                            <div class="label_value">
                                <div class="type-file-box">
                                    <div class="checkbox_items">
                                        <div class="checkbox_item">
                                            <input type="radio" name="data[is_hot]" value="1"
                                                   @if(isset($info['is_hot']) && $info['is_hot']==1)
                                                   checked
                                                    @endif
                                            >
                                        ...
                                        <div class="checkbox_item">
                                            <input type="radio" name="data[is_hot]" value="0"
                                                   @if(!isset($info['is_hot']) || $info['is_hot']==0)
                                                   checked
                                                    @endif
                                            >
                        ...
                        <div class="item">
                            <div class="label-t">{{ $lang['bargain_desc'] }}</div>
                            <div class="label_value">
                                <textarea name="data[bargain_desc]" cols="40" rows="3"
                                          class="textarea">{{ $info['bargain_desc'] ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        @if(isset($info['ru_id']) && $info['ru_id'])
                            ...
                            <div class="item">
                                <div class="label-t">{{ $lang['adopt_status'] }}</div>
                                <div class="label_value">
                                    <div class="type-file-box">
                                        <div class="checkbox_items">
                                            <div class="checkbox_item">
                                                <input type="radio" name="data[is_audit]" class="checkbox_item-1"
                                                       value="0"
                                                ...
                                                >
                                                {{--未审核--}}
                                                <label class="">{{ $lang['not_audited'] }}</label>
                                            </div>
                                            <div class="checkbox_item">
                                                <input type="radio" name="data[is_audit]" class="j-checkbox_item"
                                                ...
                                                >
                                                {{--审核未通过--}}
                                                <label class="">{{ $lang['not_through'] }}</label>
                                            </div>
                                            <div class="checkbox_item">
                                                <input type="radio" name="data[is_audit]" class="checkbox_item-1"
                                                       value="2"
                                                ...
                                                >
                                                {{--审核已通过--}}
                                                <label class="">{{ $lang['yes_through'] }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item checkbox_item-box">
                                ...
                                <div class="label_value">
                                    <textarea name="data[isnot_aduit_reason]" cols="40" rows="3"
...
<script>
    ...
    function searchGoods() {
        ...
        $.post("{{ route('admin/bargain/searchgoods') }}", {
            cat_id: cat_id,
            brand_id: brand_id,
            keyword: keyword
        }, function (data) {
    ...
    function goodsInfo(goodsId) {
        if (goodsId) {
            $.post("{{ route('admin/bargain/goodsinfo') }}", {goods_id: goodsId}, function (data) {
    ...
    function set_attribute_table(goodsId) {
        ...
        $.post("{{ route('admin/bargain/setattributetable') }}", {
            bargain_id: bargainId,
            goods_id: goodsId,
            attr_id: attr_id_arr,
            attr_value: attr_value_arr
        }, function (data) {
            if (data.content) {
    ...
    $('.letter').find('a[data-letter]').click(function () {
        ...
        $.post("{{ route('admin/bargain/searchbrand') }}", {goods_id: goods_id, letter: letter}, function (result) {
            if (result.content) {
    ...
    $('.b_search').find('a').click(function () {
        ...
        $.post("{{ route('admin/bargain/searchbrand') }}", {goods_id: goods_id, keyword: keyword}, function (result) {
            if (result.content) {
                $(".brand-list").html(result.content);
                $(".brand-not").hide();
            } else {
    ...
    jQuery.category = function () {
        ...
        $(document).on('click', '.select-list li', function () {
            ...
            $.post("{{ route('admin/bargain/filtercategory') }}", {cat_id: cat_id}, function (result) {
                if (result.content) {
