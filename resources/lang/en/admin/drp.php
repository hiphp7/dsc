...
$_LANG = [
    ...
    'log_type_1' => 'Paid purchase share',
    ...
    'drp_order_list_tips' => [
        ...
        1 => '2. Operating conditions of distribution order: the order commission in the distribution ratio setting can be divided into 7 days (default 7 days) before the operation can be divided into.',
    ...
    'drp_order_list_buy_tips' => [
        'Show paid purchases as a record of the distributor\'s revenue',
        'In the distribution proportion setting, the commission of the order can be divided into 7 days by default before the breakable operation occurs.',
    ...
    'drp_list_tips' => [
        0 => 'Distribution ranking can be based on a full year, half a year, a month for ranking query.',
        1 => 'The distribution rankings are ranked by sales commission.',
    ],
    ...
    'drp_scale_config_tips' => [
        ...
        'Distribution orders must be paid for at least 7 days before the commission can be Shared.The specific operational time can be modified below.',
    ...
    'time_not_less_than_seven' => 'The Commission can be divided into less than 7 days',
...
<p> for example: I am [$nickname] come to share qr code and become a distributor with me! </p>',
    ...
    'drp_shop_name' => 'Distribution membership card',
    ...
    'check_status' => 'Distributor status',
    'shop_status' => 'State of the store',
    'goto_audit' => 'audit',
    ...
    'drp_cfg_notice' => [
        ...
        'settlement_time' => 'After setting up the member to confirm the receipt, X days later, the distribution order will be generated.Unit: day, default 7 days',
