...
$_LANG['consume_deduction'] = "消費扣減";
$_LANG['flow_surplus_pay'] = "購物流程正常餘額支付下單";

$_LANG['bt_noll_impower'] = "對不起,您未被授權使用白條支付!";
$_LANG['bt_noll_balance'] = "對不起,您的白條額度已不足!";
$_LANG['bt_go_refund'] = "去還款";
$_LANG['bt_forbid_pay'] = "您有過期未付清的分期款額,您已被禁止下單,請先還款!";
$_LANG['bt_overdue'] = "您有過期未付清的會員白條款額,您已被禁止下單,請先付清欠款";

$_LANG['order_placed_sms'] = '您有新訂單，收貨人：%s 電話：%s';
$_LANG['order_placed_sms_ispay'] = '您有新訂單，收貨人：%s 電話：%s' . '[' . '已付款' . ']';

//ecmoban模板堂 --zhuo start
$_LANG['group_stock_insufficiency'] = "非常抱歉，您選擇的商品 %s 的套餐數量只有 %d 件，您最多只能購買 %d 件。";
//ecmoban模板堂 --zhuo end
...
$_LANG['flow_login_register']['password_lt_six'] = '密碼不能小於6個字元。';
...
$_LANG['invalid_value_card'] = "您選擇的儲值卡不存在。";
$_LANG['not_submit_order'] = "您參與本次團購商品的訂單已提交，請勿重複操作！";
$_LANG['pay_success'] = '本次支付已經成功，我們將儘快為您發貨。';
...
$_LANG['delect_cart_success'] = '刪除成功';
$_LANG['delect_cart_error'] = '刪除失敗';
...
$_LANG['select_value_card'] = '選擇已綁定儲值卡';
$_LANG['input_value_card_no'] = '或者輸入儲值卡密碼進行綁定';
$_LANG['bind_value_card'] = '綁定儲值卡';
...
/*門店 by kong 20160722*/
$_LANG['stock_store_shortage'] = "非常抱歉，您選擇的商品 %s 的門店庫存數量只有 %d，您最多只能購買 %d 件。";
$_LANG['shop_store'] = "門店";
