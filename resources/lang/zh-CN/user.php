...
$_LANG['edit_password_oldpwd_failure'] = '您输入的原密码不正确！';
$_LANG['edit_password_failure'] = '您的新密码已设置失败！';
...
$_LANG['not_exist'] = "储值卡不存在，请重新输入。";
$_LANG['unknow_error'] = '未知错误，请返回重试';
...
$_LANG['vc_money_is_used'] = '充值卡已经被使用。';
$_LANG['vc_money_not_exist'] = '充值卡不存在。';
$_LANG['vc_money_expire'] = '该充值卡已经过使用期！';
$_LANG['vc_add_error'] = '该储值卡不可充值';
...
$_LANG['add_other_goods'] = '订单包含活动或无库存商品,再看看其他商品吧~';
$_LANG['true_order_ss_received'] = '是否把此订单设为已完成';

$_LANG['application_is_successful'] = '申请成功';
$_LANG['much_applications'] = '申请次数过多';
$_LANG['not_audit_applications'] = '有未审核的申请';
$_LANG['not_your_order'] = '此订单不是您订单';
...
$_LANG['user_cancel_return'] = '你确认取消该退换货申请吗？';
...
$_LANG['level_register_up'] = '成长值分成上限';
...
$_LANG['to_rank_points'] = '恭喜您， 你%s论坛%s兑换了%s的商城成长值';
...
$_LANG['user_pay_code_null'] = "支付信息为空，请重新选择支付方式";
...
$_LANG['open'] = '打开';
$_LANG['refresh'] = '刷新';
$_LANG['code_invalid'] = '二维码已失效';
$_LANG['code_scan'] = '扫描二维码';
$_LANG['code_scan_success'] = '扫描成功!';
$_LANG['code_scan_success_notic'] = '请勿刷新本页面，按手机提示操作！';
...
$_LANG['16_no_users_real_desc'] = '未实名认证';
...
$_LANG['edit_pay_password_success'] = "修改支付密码成功！";
$_LANG['old_pay_password_empty'] = "原支付密码不能为空";
$_LANG['old_pay_password_error'] = "原支付密码不正确";
$_LANG['Enable_pay_password'] = "启用支付密码";
$_LANG['Enable_pay_password_desc'] = "启用支付密码后，将默认在使用余额和使用储值卡时通过支付密码对您进行身份认证，确保您的资金安全！";
...
$_LANG['label_captcha_input'] = '请输入图片验证码';
...
$_LANG['order_delayed_beyond'] = '已申请 %s 次不能再提交延期收货';
...
// 新绑定手机号
$_LANG['bind_mobile'] = '手机号验证';
$_LANG['bind_mobile_lable'] = '手 机 号';
$_LANG['bind_mobile_null'] = '请输入手机号';
$_LANG['bind_mobile_error'] = '手机号格式不正确';
$_LANG['bind_captcha_lable'] = '图形验证码';
$_LANG['bind_captcha_null'] = '请输入图形验证码';
$_LANG['bind_captcha_error'] = '图形验证码不正确';
$_LANG['bind_mobile_code'] = '短信验证码';
$_LANG['get_bind_mobile_code'] = '获取短信验证码';
$_LANG['bind_mobile_code_null'] = '请输入短信验证码';
$_LANG['bind_mobile_code_error'] = '短信验证码不正确';
$_LANG['bind_password_null'] = '请输入密码';
$_LANG['bind_password_again_null'] = '请再次确认密码';

$_LANG['please_change_mobile'] = '请更换手机号码';
$_LANG['mobile_isbinded'] = '该手机号已被注册或绑定';
...
$_LANG['oauth_success'] = '验证成功! 正在登录...';
$_LANG['oauth_fail'] = '验证失败';
$_LANG['bind_submit'] = '立即提交';

$_LANG['msg_authoriza_error'] = '授权失败';
$_LANG['auth_not_exit'] = '登录插件未安装或启用';
$_LANG['not_order_sn_info'] = '很抱歉，暂时无法查询此订单信息！请尝试跳转到网页查询';
$_LANG['click_jump'] = '点击跳转';

$_LANG['bind_mobile_tips'] = '依据《网络安全法》，为保障您的账户安全和正常使用，请尽快完成手机号验证！ 新版《%s隐私政策》已上线，将更有利于保护您的个人隐私。';

$_LANG['new_user_join'] = '新会员加入';


$_LANG['user_not_exist'] = '登录用户不存在';
$_LANG['user_pass_error'] = '登录密码不正确';
$_LANG['ecjia_auth_login_fail'] = 'ECjia App授权登录失败';
$_LANG['user_pass_empty'] = '密码不能为空';
$_LANG['user_pass_limit_6_20'] = '密码必须是6~20位之间';

$_LANG['send_wait'] = '频繁发送，请稍等片刻';
$_LANG['send_success'] = '发送成功';
$_LANG['send_fail'] = '发送失败';

$_LANG['field_is_write'] = '此处是必填字段';
$_LANG['login_fail'] = '登录失败';
$_LANG['order_goods_number'] = '商品件数';

$_LANG['email_verify']['button'] = '提&nbsp;交';
$_LANG['admin_user'] = "管理员：%s";

$_LANG['goods_coupons'] = '使用优惠券';
$_LANG['goods_bonus'] = '使用红包';
