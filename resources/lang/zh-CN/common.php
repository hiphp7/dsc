...
$_LANG['follow_and_receive'] = "关注店铺并领取";
/* 优惠券 end */
...
$_LANG['wechat_scan_shop'] = '微信扫码查看移动端店铺';
$_LANG['not'] = "无";
$_LANG['open'] = "展开";
...
$_LANG['statement_two'] = '2、网友讨论采用先发布后审核原则，如果我们认为您的发贴不能给其他用户带来帮助或违反国家有关规定有权删除';
...
$_LANG['copyright'] = "版权所有 &copy; 2005-%s %s，并保留所有权利。";
...
/* 评论 */
$_LANG['cmt_submit_done'] = '您的帖子已成功发表, 感谢您的参与!';
$_LANG['cmt_submit_wait'] = "您的帖子已成功发表, 请等待管理员的审核!";
...
$_LANG['rec_txt'][7] = '专题';
$_LANG['rec_txt'][8] = '众筹';
$_LANG['rec_txt'][9] = '促销活动';
$_LANG['rec_txt'][10] = '秒杀';
$_LANG['rec_txt'][11] = '超值礼包';
$_LANG['rec_txt'][12] = '拼团';
$_LANG['rec_txt'][13] = '砍价';
$_LANG['rec_txt']['offline'] = '门店';
$_LANG['cat_list'] = '购物车';
$_LANG['my_cart'] = '我的购物车';
$_LANG['back'] = '返回';
...
$_LANG['not_set_address'] = "收货人信息不完整";
$_LANG['cross_order_excess'] = '店铺商品超出';
...
$_LANG['refund_replacement_applied '] = '已申请退换货';
$_LANG['refund_replacement_appliy'] = '申请退换货';
...
$_LANG['id_card'] = '身份证号';
$_LANG['input_name'] = '请输入真实姓名';
$_LANG['input_user_id'] = '请输入身份证号码';
...
$_LANG['jigong']['apply_for_failed'] = "申请售后失败，请返回重试或联系管理员";
$_LANG['jigong']['handle_failed'] = "操作失败，请返回重试或联系管理员";

$_LANG['user_money_select'] = "详情请点击进入会员中心-资金管理页面查询";

$_LANG['friendly']['opportunity'][0] = '刚刚';
$_LANG['friendly']['opportunity'][1] = '分钟前';
$_LANG['friendly']['opportunity'][2] = '小时前';
$_LANG['friendly']['opportunity'][3] = '天前';
$_LANG['friendly']['opportunity'][4] = '月前';
$_LANG['friendly']['opportunity'][5] = '年前';
$_LANG['friendly']['opportunity'][6] = '时间不合法';
$_LANG['friendly']['opportunity'][7] = '秒前';
$_LANG['friendly']['opportunity'][8] = '今天';
$_LANG['friendly']['opportunity'][9] = '周前';
$_LANG['friendly']['opportunity'][10] = '个月前';

$_LANG['warehouse_goods_exits'] = '该商品的仓库库存已存在';
$_LANG['area_goods_exits'] = '该商品的地区价格已存在';

$_LANG['main_order_pay'] = "操作主订单支付";
$_LANG['data_empty'] = '数据为空';
$_LANG['manually_create'] = '手动创建';

$_LANG['follow_wechat'] = '关注微信';
$_LANG['down_app'] = '下载APP';
