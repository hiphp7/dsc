...
$_LANG['flow_back_home'] = '<a href="index.php">返回首页</a>';

$_LANG['flow_salve_error'] = "海量用户正在同一时刻下单，请返回重新结算";
...
$_LANG['paypwd_must_open'] = '请启用支付密码';
$_LANG['paypwd_empty'] = '支付密码不能为空';
$_LANG['paypwd_length_limit'] = '支付密码长度限制6位数字';
$_LANG['pay_password_packup_error'] = '您的支付密码有误！';

$_LANG['user_real_info_error'] = '姓名与身份证实名认证信息不匹配，请重新填写！';

$_LANG['have_no_store_goods'] = '包含不支持门店自提商品，请重新选择！';
...
$_LANG['purchasing_minimum'] = "该 '%s' 商品不能少于起购量数量";
$_LANG['youhui'] = "优惠";
...
$_LANG['shortage'] = "对不起，该商品已经库存不足暂停销售。";
$_LANG['add_package_cart_success'] = "已成功加入购物车。";
$_LANG['invalid_number'] = "数量不合法。";
...
$_LANG['balance_not_enough'] = '您输入的余额大于您实际存在的账户余额，请重新输入';
...
$_LANG['address'] = "地址";
$_LANG['phone'] = '电话';
$_LANG['flow_reminder'] = '温馨提示';
$_LANG['flow_reminder_one'] = '1、自提时付款，支持现金、POS刷卡';
$_LANG['flow_reminder_two'] = '查看自提流程';
$_LANG['flow_reminder_three'] = "2、根据您的收货地址显示其范围内的自提点，请确保您的收货地址正确填写。";
...
$_LANG['Invoice_information_no'] = "跨境商品暂不支持开具发票";
/* 新前台模板新增 start*/
...
$_LANG['back_checkout'] = "继续结算";

$_LANG['mobile_null_goods'] = "无商品";
$_LANG['mobile_cartnot_goods'] = "购物车商品不存在";
$_LANG['not_meet_low_purchase_limit'] = "未满足最低限购";
$_LANG['please_checked_shipping'] = "请选择配送方式";
$_LANG['please_checked_pay'] = "请选择支付方式";

$_LANG['goods_null_number'] = "商品缺货";
$_LANG['fittings_goods_null'] = "配件商品不存在";
$_LANG['fittings_goods_null_sold'] = "配件商品已下架";
$_LANG['goods_oneself_sold'] = "配件不允许单独销售";
