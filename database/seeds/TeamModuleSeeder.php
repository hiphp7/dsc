...
class TeamModuleSeeder extends Seeder
{
    ...
    {
        $result = DB::table('shop_config')->where('code', 'virtual_order')->count();
        $result_1 = DB::table('shop_config')->where('code', 'virtual_limit_nim')->count();
    ...
    {
        $result = DB::table('team_category')->count();
        if (empty($result)) {
            // 默认数据
            $rows = [
                [
    ...
    {
        $result = DB::table('touch_ad_position')->whereBetween('position_id', [1000, 1007])->count();

        $result_index = DB::table('touch_ad_position')->whereBetween('position_id', [1008, 1014])->count();
    ...
    {
        $result = DB::table('touch_ad')->whereBetween('position_id', [1000, 1007])->count();

		$result_index = DB::table('touch_ad')->whereBetween('position_id', [1008, 1014])->count();
    ...
    {
        $result = DB::table('touch_nav')->where('name', '拼团')->count();
    ...
    {
        $result = DB::table('admin_action')->where('action_code', 'team_manage')->count();
        if (empty($result)) {
    ...
    {
        $result = DB::table('wechat_template')->where('code', 'OPENTM407307456')->count();
        $result_1 = DB::table('wechat_template')->where('code', 'OPENTM407307456')->count();
        $result_2 = DB::table('wechat_template')->where('code', 'OPENTM407307456')->count();
        $result_3 = DB::table('wechat_template')->where('code', 'OPENTM407307456')->count();
